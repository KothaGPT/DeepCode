...
[examples directory](https://github.com/kothagpt/deepcode/tree/main/examples/raspberry-pi-pico).
...
deepcode = { version = "0.19", default-features = false, features = ["ndarray"] } # Backend must be ndarray

[build-dependencies]
deepcode-import = { version = "0.19" } # Used to auto generate the rust code to import the model
```
...
```rs
use deepcode::{backend::NdArray, tensor::Tensor};

type Backend = NdArray<f32>;
type BackendDevice = <Backend as deepcode::tensor::backend::Backend>::Device;
```
