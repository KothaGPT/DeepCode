...
This guide will walk you through the process of creating a custom model built with Deepcode. We will
...
corresponding code in the `examples/guide` [directory](https://github.com/kothagpt/deepcode/tree/main/examples/guide).
...
Be sure to checkout the git branch corresponding to the version of Deepcode you are using to follow
this guide.

The current version of Deepcode is `0.19` and the corresponding branch to checkout is `main`.
</div>

The code for this demo can be executed from Deepcode's base directory using the command:
