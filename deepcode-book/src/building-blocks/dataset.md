...
performance. Datasets in Deepcode don't assume _how_ they are going to be accessed; it's just a
collection of items.
...
Transformations in Deepcode are all lazy and modify one or multiple input datasets. The goal of these
...
found at the [API reference](https://deepcode.dev/docs/deepcode/data/dataset/transform/index.html).
...
For now, there are only a couple of dataset sources available with Deepcode, but more to come!

### Hugging Face

You can easily import any Hugging Face dataset with Deepcode. We use SQLite as the storage to avoid
...
There is no streaming dataset API with Deepcode, and this is by design! The learner struct will iterate
...
<img title="Deepcode Data Loading Pipeline" alt="Deepcode Data Loading Pipeline" src="./dataset.png">

Although we have conveniently implemented the
[`MnistDataset`](https://github.com/kothagpt/deepcode/blob/main/crates/deepcode-dataset/src/vision/mnist.rs)
...
#        // Dataset files are stored un the deepcode-dataset cache directory
#        let cache_dir = dirs::home_dir()
#            .expect("Could not get home directory")
#            .join(".cache")
#            .join("deepcode-dataset");
