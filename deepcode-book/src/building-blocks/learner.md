...
The [deepcode-train](https://github.com/kothagpt/deepcode/tree/main/crates/deepcode-train) crate encapsulates
...
from the ground up. Most of the interactions with `deepcode-train` will be with the `LearnerBuilder`
