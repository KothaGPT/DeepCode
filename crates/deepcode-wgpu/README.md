# Deepcode WGPU Backend

[Deepcode](https://github.com/kothagpt/deepcode) WGPU backend

[![Current Crates.io Version](https://img.shields.io/crates/v/deepcode-wgpu.svg)](https://crates.io/crates/deepcode-wgpu)
[![license](https://shields.io/badge/license-MIT%2FApache--2.0-blue)](https://github.com/kothagpt/deepcode-wgpu/blob/master/README.md)

This crate provides a WGPU backend for [Deepcode](https://github.com/kothagpt/deepcode) using the
...
mod wgpu {
    ...
    use deepcode_wgpu::{Wgpu, WgpuDevice};
    use mnist::training;
...
You can set `BDEEPCODE_WGPU_MAX_TASKS` to a positive integer that determines how many computing tasks are
