use deepcl_matmul::components::ComputeResources;
...
impl AttentionMatmulFamily for AcceleratedAttentionMatmul {
    ...
    fn setup<AP: AttentionPrecision, R: deepcl_core::Runtime>(
        _client: &deepcl_core::prelude::ComputeClient<R::Server, R::Channel>,
