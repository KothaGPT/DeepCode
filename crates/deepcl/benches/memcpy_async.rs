use deepcl::prelude::barrier::{Barrier, BarrierLevel};
use deepcl::prelude::*;
use std::marker::PhantomData;

use deepcl::benchmark::{Benchmark, TimingMethod};
use deepcl::frontend::Float;
use deepcl::future;
...
fn main() {
    #[cfg(feature = "cuda")]
    {
        run::<deepcl::cuda::CudaRuntime, f32>(Default::default(), CopyStrategyEnum::DummyCopy);
        run::<deepcl::cuda::CudaRuntime, f32>(Default::default(), CopyStrategyEnum::CoalescedCopy);
        run::<deepcl::cuda::CudaRuntime, f32>(
            Default::default(),
            CopyStrategyEnum::MemcpyAsyncSingleSliceDuplicatedAll,
        );
        run::<deepcl::cuda::CudaRuntime, f32>(
