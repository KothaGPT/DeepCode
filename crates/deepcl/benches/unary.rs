use deepcl::{calculate_cube_count_elemwise, frontend, prelude::*};
...
fn main() {
    #[cfg(feature = "cuda")]
    run::<deepcl::cuda::CudaRuntime, f16>(Default::default(), 8);
    #[cfg(feature = "cuda")]
    run::<deepcl::cuda::CudaRuntime, f32>(Default::default(), 4);
    #[cfg(feature = "wgpu")]
    run::<deepcl::wgpu::WgpuRuntime, f32>(Default::default(), 1);
    #[cfg(feature = "wgpu")]
    run::<deepcl::wgpu::WgpuRuntime, f32>(Default::default(), 4);
}
