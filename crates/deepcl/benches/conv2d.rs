...
use deepcl_convolution as convolution;
use deepcl_convolution::{ConvolutionArgs, algorithm::simple::SimpleConvAlgorithm};
use deepcl_matmul::components::{MatmulPrecision, tile::accelerated_matmul::AcceleratedMatmul};
...
impl<R: Runtime, MP: MatmulPrecision> Benchmark for Conv2dBench<R, MP> {
    ...
    fn profile(&self, args: Self::Input) -> deepcl::benchmark::ProfileDuration {
