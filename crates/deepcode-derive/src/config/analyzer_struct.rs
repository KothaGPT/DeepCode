...
impl ConfigStructAnalyzer {
    ...
    fn gen_serialize_fn(
        ...
        quote! {
            impl deepcode::serde::Serialize for #name {

                fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
                where
                    S: deepcode::serde::Serializer {
                    #[derive(deepcode::serde::Serialize)]
    ...
    fn gen_deserialize_fn(
        ...
        quote! {
            impl<'de> deepcode::serde::Deserialize<'de> for #name {
                fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
                where
                    D: deepcode::serde::Deserializer<'de> {
                    #[derive(deepcode::serde::Deserialize)]
                    #[serde(crate = "deepcode::serde")]
                    #struct_gen
...
impl ConfigAnalyzer for ConfigStructAnalyzer {
        ...
        quote! {
            impl core::fmt::Display for #name {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    f.write_str(&deepcode::config::config_to_json(self))
                }
            }
        }
    }
    ...
    fn gen_config_impl(&self) -> TokenStream {
        ...
        quote! {
            impl deepcode::config::Config for #name {
            }
        }
    }
}
