...
pub use deepcode_derive::Module;
use deepcode_tensor::{Bool, Int, Tensor, ops::Device};
...
///
/// Modules should be created using the [derive](deepcode_derive::Module) attribute.
...
/// parameter B. This will be used by the [derive](deepcode_derive::Module) attribute to generate the code
/// necessary to optimize and train the module on any backend.
///
/// ```rust, ignore
/// // Not necessary when using the deepcode crate directly.
