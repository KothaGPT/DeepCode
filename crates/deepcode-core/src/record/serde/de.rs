...
use super::{adapter::DeepcodeModuleAdapter, error::Error};
...
pub struct Deserializer<A: DeepcodeModuleAdapter> {
...
impl<A: DeepcodeModuleAdapter> Deserializer<A> {
...
impl<'de, A: DeepcodeModuleAdapter> serde::Deserializer<'de> for Deserializer<A> {
    type Error = Error;
...
struct VecSeqAccess<A: DeepcodeModuleAdapter, I> {
...
impl<A: DeepcodeModuleAdapter> VecSeqAccess<A, NestedValue> {
...
impl<A: DeepcodeModuleAdapter> VecSeqAccess<A, u8> {
    fn new(vec: NestedValue, default_for_missing_fields: bool) -> Self {
        match vec {
...
impl<A: DeepcodeModuleAdapter> VecSeqAccess<A, u16> {
    fn new(vec: NestedValue, default_for_missing_fields: bool) -> Self {
        match vec {
...
impl<A: DeepcodeModuleAdapter> VecSeqAccess<A, f32> {
    fn new(vec: NestedValue, default_for_missing_fields: bool) -> Self {
        match vec {
...
struct HashMapAccess<A: DeepcodeModuleAdapter> {
...
impl<A: DeepcodeModuleAdapter> HashMapAccess<A> {
...
struct ProbeEnumAccess<A: DeepcodeModuleAdapter> {
    value: NestedValue,
...
impl<A: DeepcodeModuleAdapter> ProbeEnumAccess<A> {
    ...
    A: DeepcodeModuleAdapter,
{
    ...
    fn unit_variant(self) -> Result<(), Self::Error> {
        ...
        match self.value {
            ...
            _ => unimplemented!(
                "unit variant is not implemented because it is not used in the deepcode module"
            ),
        }
    }
    ...
    where
        V: Visitor<'de>,
    {
        unimplemented!("tuple variant is not implemented because it is not used in the deepcode module")
    }
    ...
    {
        unimplemented!(
            "struct variant is not implemented because it is not used in the deepcode module"
        )
    }
}

/// A wrapper for the nested value data structure with a deepcode module adapter.
struct NestedValueWrapper<A: DeepcodeModuleAdapter> {
    value: NestedValue,
    default_for_missing_fields: bool,
    phantom: std::marker::PhantomData<A>,
}

impl<A: DeepcodeModuleAdapter> NestedValueWrapper<A> {
...
impl<A: DeepcodeModuleAdapter> IntoDeserializer<'_, Error> for NestedValueWrapper<A> {
