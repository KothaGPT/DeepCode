...
/// A trait that defines the adapter for a Deepcode module.
///
/// This is used to adapt an incoming module to a Deepcode module.
pub trait DeepcodeModuleAdapter: Sized {
    /// Adapts a module.
...
impl DeepcodeModuleAdapter for DefaultAdapter {}
