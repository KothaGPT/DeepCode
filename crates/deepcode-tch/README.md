# Deepcode Torch Backend

[Deepcode](https://github.com/kothagpt/deepcode) Torch backend

[![Current Crates.io Version](https://img.shields.io/crates/v/deepcode-tch.svg)](https://crates.io/crates/deepcode-tch)
[![license](https://shields.io/badge/license-MIT%2FApache--2.0-blue)](https://github.com/kothagpt/deepcode-tch/blob/master/README.md)

This crate provides a Torch backend for [Deepcode](https://github.com/kothagpt/deepcode) utilizing the
...
before building `deepcode-tch` or a crate which depends on it.
...
PowerShell commands below before building `deepcode-tch` or a crate which depends on it.
...
[Deepcode mnist example](https://github.com/kothagpt/deepcode/tree/main/examples/mnist).
