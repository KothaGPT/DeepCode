...
use deepcode_tensor::backend::{Backend, DeviceId, DeviceOps};
use deepcode_tensor::ops::IntTensorOps;
use deepcode_tensor::{Int, Tensor};
...
///
/// ```no_run
/// use deepcode_tch::LibTorchDevice;
///
...
impl deepcode_common::device::Device for LibTorchDevice {
...
/// [deepcode-tch](https://github.com/kothagpt/deepcode/tree/main/crates/deepcode-tch).
///
