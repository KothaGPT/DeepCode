...
use deepcode_tensor::{DType, FloatDType, IntDType, Shape, TensorData, TensorMetadata};
use libc::c_void;
use std::sync::Arc;
...
impl deepcode_tensor::quantization::QTensorPrimitive for TchTensor {
...
mod tests {
    ...
    use super::*;
    use deepcode_tensor::{Distribution, Tensor, TensorPrimitive};
