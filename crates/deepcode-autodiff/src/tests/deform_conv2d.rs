#[deepcode_tensor_testgen::testgen(ad_deform_conv2d)]
mod tests {
    use super::*;
    use deepcode_tensor::{ElementConversion, Tolerance};
    use deepcode_tensor::{Shape, module::deform_conv2d, ops::DeformConvOptions};
