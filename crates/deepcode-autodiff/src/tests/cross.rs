#[deepcode_tensor_testgen::testgen(ad_cross)]
mod tests {
    use super::*;
    use deepcode_tensor::might_panic;
    use deepcode_tensor::{TensorData, Tolerance, ops::FloatElem};
    ...
    fn different_dim() {
        ...
        // Cross along dim 0. Some backends (for example DeepCL) may not support
