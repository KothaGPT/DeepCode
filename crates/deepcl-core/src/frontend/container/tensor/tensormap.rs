...
use deepcl_ir::{StorageType, Type};
use deepcl_runtime::server::TensorMapMeta;
use paste::paste;
use serde::{Deserialize, Serialize};

pub use deepcl_runtime::tma::*;
    ...
    ($dim: literal, $($arg: expr),*) => {
        paste! {
            ...
            pub mod [<tma_store_ $dim d>] {
                use deepcl_ir::{Instruction, TmaOps};
...
mod metadata {
    use deepcl_ir::{ExpandElement, Metadata, Type, VariableKind};
