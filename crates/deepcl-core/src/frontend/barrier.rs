...
use deepcl_ir::{ExpandElement, Instruction};
use paste::paste;
...
impl From<InnerBarrierLevel> for deepcl_ir::BarrierLevel {
    fn from(val: InnerBarrierLevel) -> Self {
        match val {
            InnerBarrierLevel::Unit => deepcl_ir::BarrierLevel::Unit,
            InnerBarrierLevel::CubeCoop(elected_unit) => {
                deepcl_ir::BarrierLevel::CubeCoop(elected_unit)
            }
            InnerBarrierLevel::CubeManual(elected_unit) => {
                deepcl_ir::BarrierLevel::CubeManual(elected_unit)
            }
        }
    }
}
