...
use deepcl_ir::{ExpandElement, Scope};
...
constant!(
    CUBE_CLUSTER_DIM,
    crate::ir::Builtin::DeepClusterDim,
    r"
...
constant!(
    CUBE_CLUSTER_DIM_X,
    crate::ir::Builtin::DeepClusterDimX,
    r"
...
constant!(
    CUBE_CLUSTER_DIM_Y,
    crate::ir::Builtin::DeepClusterDimY,
    r"
...
constant!(
    CUBE_CLUSTER_DIM_Z,
    crate::ir::Builtin::DeepClusterDimZ,
    r"
