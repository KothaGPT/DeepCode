...
macro_rules! testgen_sync_plane {
    () => {
        ...
        fn test_sync_plane() {
            ...
            deepcl_core::runtime_tests::synchronization::test_sync_plane::<TestRuntime>(client);
        }

        #[test]
        fn test_sync_cube() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::synchronization::test_sync_cube::<TestRuntime>(client);
        }

        #[test]
        fn test_finished_sync_cube() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::synchronization::test_finished_sync_cube::<TestRuntime>(
                client,
            );
        }
    };
