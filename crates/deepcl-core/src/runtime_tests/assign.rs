...
macro_rules! testgen_assign {
    () => {
        ...
        fn test_assign_scalar() {
            ...
            deepcl_core::runtime_tests::assign::test_kernel_assign_scalar::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_add_assign_array() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::assign::test_kernel_add_assign_array::<
                TestRuntime,
                FloatType,
            >(client);
        }
        ...
        fn test_add_assign_line() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::assign::test_kernel_add_assign_line::<
                TestRuntime,
                FloatType,
            >(client);
        }
