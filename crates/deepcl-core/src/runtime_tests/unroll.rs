...
macro_rules! testgen_unroll {
    () => {
        ...
        fn test_unroll_add() {
            ...
            deepcl_core::runtime_tests::unroll::test_unroll_add::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_unroll_load_store() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::unroll::test_unroll_load_store::<TestRuntime, FloatType>(
                client,
            );
        }
    };
