...
macro_rules! testgen_metadata {
    () => {
        ...
        fn test_shape() {
            ...
            deepcl_core::runtime_tests::metadata::test_shape_dim_4::<TestRuntime>(client.clone());
            deepcl_core::runtime_tests::metadata::test_shape_different_ranks::<TestRuntime>(client);
        }

        #[test]
        fn test_stride() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::metadata::test_stride_different_ranks::<TestRuntime>(
                client,
            );
        }
        ...
        fn test_len() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::metadata::test_len_different_ranks::<TestRuntime>(client);
        }

        #[test]
        fn test_buffer_len_discontiguous() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::metadata::test_buffer_len_discontiguous::<TestRuntime>(
                client,
            );
        }
        ...
        fn test_buffer_len_vectorized() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::metadata::test_buffer_len_vectorized::<TestRuntime>(client);
        }

        #[test]
        fn test_buffer_len_offset() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::metadata::test_buffer_len_offset::<TestRuntime>(client);
        }
    };
}
