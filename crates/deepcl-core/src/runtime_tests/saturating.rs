...
macro_rules! testgen_saturating_uint {
    () => {
        ...
        fn test_saturating_add_unsigned() {
            ...
            let test = deepcl_core::runtime_tests::saturating::test_saturating_add_unsigned::<
                TestRuntime,
                UintType,
            >;
            test(client.clone(), 1);
        ...
        fn test_saturating_sub_unsigned() {
            let client = TestRuntime::client(&Default::default());
            let test = deepcl_core::runtime_tests::saturating::test_saturating_sub_unsigned::<
                TestRuntime,
                UintType,
            >;
            test(client.clone(), 1);
...
macro_rules! testgen_saturating_int {
    () => {
        ...
        fn test_saturating_add_signed() {
            let client = TestRuntime::client(&Default::default());
            let test = deepcl_core::runtime_tests::saturating::test_saturating_add_signed::<
                TestRuntime,
                IntType,
            >;
            test(client.clone(), 1);
        ...
        fn test_saturating_sub_signed() {
            let client = TestRuntime::client(&Default::default());
            let test = deepcl_core::runtime_tests::saturating::test_saturating_sub_signed::<
                TestRuntime,
                IntType,
            >;
            test(client.clone(), 1);
