use crate::{self as deepcl, as_type};

use deepcl::prelude::*;
use deepcl_common::{e2m1x2, e2m3, e3m2, e4m3, e5m2, ue8m0};
...
macro_rules! testgen_minifloat {
    () => {
        ...
        fn test_fp8() {
            ...
            deepcl_core::runtime_tests::minifloat::test_fp8::<TestRuntime, FloatType>(
                client.clone(),
                1,
            );
            deepcl_core::runtime_tests::minifloat::test_fp8::<TestRuntime, FloatType>(
        ...
        fn test_fp6() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::minifloat::test_fp6::<TestRuntime, FloatType>(
                client.clone(),
                1,
            );
            deepcl_core::runtime_tests::minifloat::test_fp6::<TestRuntime, FloatType>(
        ...
        fn test_fp4() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::minifloat::test_fp4::<TestRuntime, FloatType>(
                client.clone(),
                2,
            );
            deepcl_core::runtime_tests::minifloat::test_fp4::<TestRuntime, FloatType>(
        ...
        fn test_scale() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::minifloat::test_scale::<TestRuntime>(client.clone(), 1);
            deepcl_core::runtime_tests::minifloat::test_scale::<TestRuntime>(client.clone(), 2);
            deepcl_core::runtime_tests::minifloat::test_scale::<TestRuntime>(client.clone(), 4);
        }
    };
}
