...
macro_rules! testgen_sequence {
    () => {
        ...
        fn test_sequence_for_loop() {
            ...
            deepcl_core::runtime_tests::sequence::test_sequence_for_loop::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_sequence_index() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::sequence::test_sequence_index::<TestRuntime, FloatType>(
                client,
            );
        }
    };
