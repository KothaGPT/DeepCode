...
macro_rules! testgen_atomic_int {
    () => {
        ...
        fn test_atomic_add_int() {
            ...
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_add::<TestRuntime, IntType>(
                client,
            );
        }
        ...
        fn test_atomic_min_int() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_min::<TestRuntime, IntType>(
                client,
            );
        }
        ...
        fn test_atomic_max_int() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_max::<TestRuntime, IntType>(
                client,
            );
        }
    };
...
macro_rules! testgen_atomic_float {
    () => {
        ...
        fn test_atomic_add_float() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_add::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_atomic_min_float() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_min::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_atomic_max_float() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::atomic::test_kernel_atomic_max::<TestRuntime, FloatType>(
                client,
            );
        }
    };
