...
macro_rules! testgen_branch {
    () => {
        ...
        fn test_switch_statement() {
            ...
            deepcl_core::runtime_tests::branch::test_switch_statement::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_used_as_value() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::branch::test_switch_used_as_value::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_default() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::branch::test_switch_default::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_or_branch() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::branch::test_switch_or_branch::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_select_true() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::branch::test_select::<TestRuntime, FloatType>(client, true);
        }

        #[test]
        fn test_select_false() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::branch::test_select::<TestRuntime, FloatType>(
                client, false,
            );
        }
    };
