use crate::{self as deepcl, as_bytes};
use deepcl::prelude::*;
...
macro_rules! testgen_line {
    () => {
        ...
        fn test_line_index() {
            ...
            deepcl_core::runtime_tests::line::test_line_index::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_line_index_assign() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_index_assign::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_line_loop_unroll() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_loop_unroll::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_shared_memory() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_shared_memory::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_line_equal() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_equal::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_line_not_equal() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_not_equal::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_line_less_than() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_less_than::<TestRuntime, FloatType>(client);
        }

        #[test]
        fn test_line_greater_than() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_greater_than::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_line_less_equal() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_less_equal::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_line_greater_equal() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::line::test_line_greater_equal::<TestRuntime, FloatType>(
                client,
            );
        }
    };
