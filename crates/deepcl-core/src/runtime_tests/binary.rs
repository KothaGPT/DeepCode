...
use deepcl::prelude::*;
use deepcl_runtime::server::Handle;
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        ...
                        deepcl_core::runtime_tests::binary::$test_name::<TestRuntime, FloatType>(
                            client,
                        );
                    }
                };
        ...
        mod binary_untyped {
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        let client = TestRuntime::client(&Default::default());
                        deepcl_core::runtime_tests::binary::$test_name::<TestRuntime>(client);
                    }
                };
                ($test_name:ident, $ty:ty) => {
                    ...
                    fn $test_name() {
                        let client = TestRuntime::client(&Default::default());
                        deepcl_core::runtime_tests::binary::$test_name::<TestRuntime, $ty>(client);
                    }
                };
            }
