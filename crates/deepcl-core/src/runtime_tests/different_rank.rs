...
macro_rules! testgen_different_rank {
    () => {
        ...
        fn test_kernel_different_rank_first_biggest() {
            ...
            deepcl_core::runtime_tests::different_rank::test_kernel_different_rank_first_biggest::<
                TestRuntime,
                FloatType,
            >(client);
        }
        ...
        fn test_kernel_different_rank_last_biggest() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::different_rank::test_kernel_different_rank_last_biggest::<
                TestRuntime,
                FloatType,
            >(client);
        }
