...
use crate::{self as deepcl};
use deepcl::prelude::*;
use deepcl_runtime::Plane;
...
macro_rules! testgen_plane {
    () => {
        ...
        fn impl_test_plane_sum(vectorization: u8) {
            ...
            deepcl_core::runtime_tests::plane::test_plane_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_inclusive_sum(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_inclusive_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_exclusive_sum(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_exclusive_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_prod(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_inclusive_prod(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_inclusive_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_exclusive_prod(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_exclusive_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_max(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_max::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_min(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_min::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_all(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_all::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_any(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_any::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_elect(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_elect::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_broadcast(vectorization: u8) {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_broadcast::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn test_plane_ballot() {
            let client = TestRuntime::client(&Default::default());
            deepcl_core::runtime_tests::plane::test_plane_ballot::<TestRuntime>(client.clone());
        }
    };
}
