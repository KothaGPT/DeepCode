...
use deepcode_tensor::{Shape, Tensor, TensorData, backend::Backend};
...
macro_rules! testgen_all {
    () => {
        use deepcode_tensor::{Bool, Float, Int};

        pub type TestTensor<const D: usize> = deepcode_tensor::Tensor<TestBackend, D>;
        pub type TestTensorInt<const D: usize> = deepcode_tensor::Tensor<TestBackend, D, Int>;
        pub type TestTensorBool<const D: usize> = deepcode_tensor::Tensor<TestBackend, D, Bool>;
        ...
        pub mod vision {
            ...
            deepcode_vision::testgen_connected_components!();
            deepcode_vision::testgen_morphology!();
        }
    };
}
