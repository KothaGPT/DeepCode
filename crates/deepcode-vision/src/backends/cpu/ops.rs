...
mod candle {
    use crate::{BoolVisionOps, FloatVisionOps, IntVisionOps, QVisionOps, VisionBackend};
    use deepcode_candle::{Candle, FloatCandleElement, IntCandleElement};
...
mod tch {
    use crate::{BoolVisionOps, FloatVisionOps, IntVisionOps, QVisionOps, VisionBackend};
    use deepcode_tch::{LibTorch, TchElement};

    impl<E: TchElement, Q: deepcode_tch::QuantElement> BoolVisionOps for LibTorch<E, Q> {}
    impl<E: TchElement, Q: deepcode_tch::QuantElement> IntVisionOps for LibTorch<E, Q> {}
    impl<E: TchElement, Q: deepcode_tch::QuantElement> FloatVisionOps for LibTorch<E, Q> {}
    impl<E: TchElement, Q: deepcode_tch::QuantElement> QVisionOps for LibTorch<E, Q> {}
    impl<E: TchElement, Q: deepcode_tch::QuantElement> VisionBackend for LibTorch<E, Q> {}
}
