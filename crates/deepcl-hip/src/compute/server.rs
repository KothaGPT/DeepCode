...
use deepcl_common::bytes::Bytes;
use deepcl_common::future::DynFut;
use deepcl_common::profile::ProfileDuration;
use deepcl_common::stream_id::StreamId;
use deepcl_core::compute::CubeTask;
use deepcl_core::server::ServerCommunication;
use deepcl_core::server::{
    Allocation, AllocationKind, CopyDescriptor, IoError, ProfileError, ProfilingToken,
};
use deepcl_core::server::{Binding, Bindings};
use deepcl_core::{MemoryConfiguration, future, prelude::*};
use deepcl_runtime::config::GlobalConfig;
use deepcl_runtime::logging::ServerLogger;
use deepcl_runtime::memory_management::{MemoryAllocationMode, MemoryUsage};
use deepcl_runtime::memory_management::{MemoryDeviceProperties, offset_handles};
...
impl ComputeServer for HipServer {
    ...
    fn start_profile(&mut self, stream_id: StreamId) -> ProfilingToken {
        deepcl_common::future::block_on(self.sync(stream_id));
