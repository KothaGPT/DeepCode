...
pub struct GpuStorage {
    mem_alignment: usize,
    memory: HashMap<StorageId, deepcl_hip_sys::hipDeviceptr_t>,
...
pub struct GpuResource {
    ...
    pub ptr: deepcl_hip_sys::hipDeviceptr_t,
    /// The HIP binding pointer.
    pub binding: deepcl_hip_sys::hipDeviceptr_t,
...
impl ComputeStorage for GpuStorage {
    ...
    fn get(&mut self, handle: &StorageHandle) -> Self::Resource {
        ...
        GpuResource::new(
            *ptr as deepcl_hip_sys::hipDeviceptr_t,
    ...
    fn alloc(&mut self, size: u64) -> Result<StorageHandle, IoError> {
        ...
        unsafe {
            ...
            let status = deepcl_hip_sys::hipMalloc(&mut dptr, size as usize);
