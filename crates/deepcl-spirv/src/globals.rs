use deepcl_core::ir::{self, Builtin, UIntKind};
...
impl<T: SpirvTarget> SpirvCompiler<T> {
    pub fn compile_builtin(&mut self, builtin: Builtin) -> Variable {
        match builtin {
            ...
            Builtin::DeepClusterDim
            | Builtin::DeepClusterDimX
            | Builtin::DeepClusterDimY
            | Builtin::DeepClusterDimZ => self.constant_var(1),
            Builtin::CubeCount => {
