...
pub enum FloatOperationIr {
    /// Operation corresponding to [exp](deepcode_tensor::ops::FloatTensorOps::float_exp).
    Exp(UnaryOpIr),
    /// Operation corresponding to [log](deepcode_tensor::ops::FloatTensorOps::float_log).
    Log(UnaryOpIr),
    /// Operation corresponding to [log1p](deepcode_tensor::ops::FloatTensorOps::float_log1p).
    Log1p(UnaryOpIr),
    /// Operation corresponding to [erf](deepcode_tensor::ops::FloatTensorOps::float_erf).
    Erf(UnaryOpIr),
    /// Operation corresponding to [powf_scalar](deepcode_tensor::ops::FloatTensorOps::float_powf_scalar).
    PowfScalar(ScalarOpIr),
    /// Operation corresponding to [sqrt](deepcode_tensor::ops::FloatTensorOps::float_sqrt).
    Sqrt(UnaryOpIr),
    /// Operation corresponding to [cos](deepcode_tensor::ops::FloatTensorOps::float_cos).
    Cos(UnaryOpIr),
    /// Operation corresponding to [sin](deepcode_tensor::ops::FloatTensorOps::float_sin).
    Sin(UnaryOpIr),
    /// Operation corresponding to [tanh](deepcode_tensor::ops::FloatTensorOps::float_tanh).
    Tanh(UnaryOpIr),
    /// Operation corresponding to [round](deepcode_tensor::ops::FloatTensorOps::float_round).
    Round(UnaryOpIr),
    /// Operation corresponding to [floor](deepcode_tensor::ops::FloatTensorOps::float_floor).
    Floor(UnaryOpIr),
    /// Operation corresponding to [ceil](deepcode_tensor::ops::FloatTensorOps::float_ceil).
    Ceil(UnaryOpIr),
    /// Operation corresponding to [into_int](deepcode_tensor::ops::FloatTensorOps::float_into_int).
    IntoInt(UnaryOpIr),
    /// Operation corresponding to [matmul](deepcode_tensor::ops::FloatTensorOps::float_matmul).
    Matmul(BinaryOpIr),
    /// Operation corresponding to [cross](deepcode_tensor::ops::FloatTensorOps::float_cross).
    Cross(CrossOpIr),
    /// Operation corresponding to [random](deepcode_tensor::ops::FloatTensorOps::float_random).
    Random(RandomOpIr),
    /// Operation corresponding to [recip](deepcode_tensor::ops::FloatTensorOps::float_recip).
    Recip(UnaryOpIr),
    /// Operation corresponding to [is_nan](deepcode_tensor::ops::FloatTensorOps::float_is_nan).
    IsNan(UnaryOpIr),
    /// Operation corresponding to [is_nan](deepcode_tensor::ops::FloatTensorOps::float_is_inf).
    IsInf(UnaryOpIr),
    /// Operation corresponding to [quantize](deepcode_tensor::ops::QTensorOps::quantize).
    Quantize(QuantizeOpIr),
    /// Operation corresponding to [dequantize](deepcode_tensor::ops::QTensorOps::dequantize).
...
pub enum ModuleOperationIr {
    /// Operation corresponding to [embedding](deepcode_tensor::ops::ModuleOps::embedding).
    Embedding(EmbeddingOpIr),
    /// Operation corresponding to [embedding_backward](deepcode_tensor::ops::ModuleOps::embedding_backward).
    EmbeddingBackward(EmbeddingBackwardOpIr),
    /// Operation corresponding to [conv1d](deepcode_tensor::ops::ModuleOps::conv1d).
    Conv1d(Conv1dOpIr),
    /// Operation corresponding to [conv2d](deepcode_tensor::ops::ModuleOps::conv2d).
    Conv2d(Conv2dOpIr),
    /// Operation corresponding to [conv3d](deepcode_tensor::ops::ModuleOps::conv3d).
    Conv3d(Conv3dOpIr),
    /// Operation corresponding to [deform_conv2d](deepcode_tensor::ops::ModuleOps::deform_conv2d)
    DeformableConv2d(Box<DeformConv2dOpIr>),
    /// Operation corresponding to [deform_conv2d_backward](deepcode_tensor::ops::ModuleOps::deform_conv2d_backward)
    DeformableConv2dBackward(Box<DeformConv2dBackwardOpIr>),
    /// Operation corresponding to [conv transpose 1d](deepcode_tensor::ops::ModuleOps::conv_transpose1d).
    ConvTranspose1d(ConvTranspose1dOpIr),
    /// Operation corresponding to [conv transpose 2d](deepcode_tensor::ops::ModuleOps::conv_transpose2d).
    ConvTranspose2d(ConvTranspose2dOpIr),
    /// Operation corresponding to [conv transpose 3d](deepcode_tensor::ops::ModuleOps::conv_transpose3d).
    ConvTranspose3d(ConvTranspose3dOpIr),
    /// Operation corresponding to [avg pool 1d](deepcode_tensor::ops::ModuleOps::avg_pool1d).
    AvgPool1d(AvgPool1dOpIr),
    /// Operation corresponding to [avg pool 2d](deepcode_tensor::ops::ModuleOps::avg_pool2d).
    AvgPool2d(AvgPool2dOpIr),
    /// Operation corresponding to
    /// [avg pool 1d backward](deepcode_tensor::ops::ModuleOps::avg_pool1d_backward).
    AvgPool1dBackward(AvgPool1dBackwardOpIr),
    /// Operation corresponding to
    /// [avg pool 2d backward](deepcode_tensor::ops::ModuleOps::avg_pool2d_backward).
    AvgPool2dBackward(AvgPool2dBackwardOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 1d](deepcode_tensor::ops::ModuleOps::adaptive_avg_pool1d).
    AdaptiveAvgPool1d(AdaptiveAvgPool1dOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 2d](deepcode_tensor::ops::ModuleOps::adaptive_avg_pool2d).
    AdaptiveAvgPool2d(AdaptiveAvgPool2dOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 1d backward](deepcode_tensor::ops::ModuleOps::adaptive_avg_pool1d_backward).
    AdaptiveAvgPool1dBackward(AdaptiveAvgPool1dBackwardOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 2d backward](deepcode_tensor::ops::ModuleOps::adaptive_avg_pool2d_backward).
    AdaptiveAvgPool2dBackward(AdaptiveAvgPool2dBackwardOpIr),
    /// Operation corresponding to
    /// [max pool 1d](deepcode_tensor::ops::ModuleOps::max_pool1d).
    MaxPool1d(MaxPool1dOpIr),
    /// Operation corresponding to
    /// [max pool 1d with indices](deepcode_tensor::ops::ModuleOps::max_pool1d_with_indices).
    MaxPool1dWithIndices(MaxPool1dWithIndicesOpIr),
    /// Operation corresponding to
    /// [max pool 1d with indices backward](deepcode_tensor::ops::ModuleOps::max_pool1d_with_indices_backward).
    MaxPool1dWithIndicesBackward(MaxPool1dWithIndicesBackwardOpIr),
    /// Operation corresponding to
    /// [max pool 2d](deepcode_tensor::ops::ModuleOps::max_pool1d).
    MaxPool2d(MaxPool2dOpIr),
    /// Operation corresponding to
    /// [max pool 2d with indices](deepcode_tensor::ops::ModuleOps::max_pool2d_with_indices).
    MaxPool2dWithIndices(MaxPool2dWithIndicesOpIr),
    /// Operation corresponding to
    /// [max pool 2d with indices backward](deepcode_tensor::ops::ModuleOps::max_pool2d_with_indices_backward).
    MaxPool2dWithIndicesBackward(MaxPool2dWithIndicesBackwardOpIr),
    /// Operation corresponding to [interpolate](deepcode_tensor::ops::ModuleOps::interpolate).
    Interpolate(InterpolateOpIr),
    /// Operation corresponding to [interpolate backward](deepcode_tensor::ops::ModuleOps::interpolate_backward).
...
pub enum BaseOperationIr {
    /// Operation corresponding to:
    ///
    /// Float => [to device](deepcode_tensor::ops::FloatTensorOps::float_to_device).
    /// Int => [to device](deepcode_tensor::ops::IntTensorOps::int_to_device).
    /// Bool => [to device](deepcode_tensor::ops::BoolTensorOps::bool_to_device).
    ToDevice(TensorIr),
    /// Operation corresponding to:
    ///
    /// Float => [reshape](deepcode_tensor::ops::FloatTensorOps::float_reshape).
    /// Int => [reshape](deepcode_tensor::ops::IntTensorOps::int_reshape).
    /// Bool => [reshape](deepcode_tensor::ops::BoolTensorOps::bool_reshape).
    Reshape(UnaryOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [swap_dims](deepcode_tensor::ops::FloatTensorOps::float_swap_dims).
    /// Int => [swap_dims](deepcode_tensor::ops::IntTensorOps::int_swap_dims).
    /// Bool => [swap_dims](deepcode_tensor::ops::BoolTensorOps::bool_swap_dims).
    SwapDims(SwapDimsOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [permute](deepcode_tensor::ops::FloatTensorOps::float_permute).
    /// Int => [permute](deepcode_tensor::ops::IntTensorOps::int_permute).
    /// Bool => [permute](deepcode_tensor::ops::BoolTensorOps::bool_permute).
    Permute(PermuteOpIr),

    /// Operation corresponding to:
    /// Float => [flip](deepcode_tensor::ops::FloatTensorOps::float_flip).
    /// Int => [flip](deepcode_tensor::ops::IntTensorOps::int_flip).
    /// Bool => [flip](deepcode_tensor::ops::BoolTensorOps::bool_flip).
    Flip(FlipOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [expand](deepcode_tensor::ops::FloatTensorOps::float_expand).
    /// Int => [expand](deepcode_tensor::ops::IntTensorOps::int_expand).
    /// Bool => [expand](deepcode_tensor::ops::BoolTensorOps::bool_expand).
    Expand(ExpandOpIr),
    ...
    /// Operation corresponding to:
    ///
    /// Float => [slice](deepcode_tensor::ops::FloatTensorOps::float_slice).
    /// Int => [slice](deepcode_tensor::ops::IntTensorOps::int_slice).
    /// Bool => [slice](deepcode_tensor::ops::BoolTensorOps::bool_slice).
    Slice(SliceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [slice assign](deepcode_tensor::ops::FloatTensorOps::float_slice_assign).
    /// Int => [slice assign](deepcode_tensor::ops::IntTensorOps::int_slice_assign).
    /// Bool => [slice assign](deepcode_tensor::ops::BoolTensorOps::bool_slice_assign).
    SliceAssign(SliceAssignOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [equal](deepcode_tensor::ops::FloatTensorOps::float_equal).
    /// Int => [equal](deepcode_tensor::ops::IntTensorOps::int_equal).
    /// Bool => [equal](deepcode_tensor::ops::BoolTensorOps::bool_equal).
    Equal(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [repeat dim](deepcode_tensor::ops::FloatTensorOps::float_repeat_dim).
    /// Int => [repeat dim](deepcode_tensor::ops::IntTensorOps::int_repeat_dim).
    /// Bool => [repeat dim](deepcode_tensor::ops::BoolTensorOps::bool_repeat_dim).
    RepeatDim(RepeatDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cat](deepcode_tensor::ops::FloatTensorOps::float_cat).
    /// Int => [cat](deepcode_tensor::ops::IntTensorOps::int_cat).
    /// Bool => [cat](deepcode_tensor::ops::BoolTensorOps::bool_cat).
    Cat(CatOpIr),
    ...
    /// Operation corresponding to:
    ///
    /// Float => [cumsum](deepcode_tensor::ops::FloatTensorOps::float_cumsum).
    /// Int => [cumsum](deepcode_tensor::ops::IntTensorOps::int_cumsum).
    CumSum(DimOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [empty](deepcode_tensor::ops::FloatTensorOps::float_empty).
    /// Int => [empty](deepcode_tensor::ops::IntTensorOps::int_empty).
    /// Bool => [empty](deepcode_tensor::ops::BoolTensorOps::bool_empty).
    Empty(TensorIr),
}
...
pub enum NumericOperationIr {
    /// Operation corresponding to:
    ///
    /// Float => [add](deepcode_tensor::ops::FloatTensorOps::float_add).
    /// Int => [add](deepcode_tensor::ops::IntTensorOps::int_add).
    Add(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [add scalar](deepcode_tensor::ops::FloatTensorOps::float_add_scalar).
    /// Int => [add scalar](deepcode_tensor::ops::IntTensorOps::int_add_scalar).
    AddScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sub](deepcode_tensor::ops::FloatTensorOps::float_sub).
    /// Int => [sub](deepcode_tensor::ops::IntTensorOps::int_sub).
    Sub(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sub scalar](deepcode_tensor::ops::FloatTensorOps::float_sub_scalar).
    /// Int => [sub scalar](deepcode_tensor::ops::IntTensorOps::int_sub_scalar).
    SubScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [div](deepcode_tensor::ops::FloatTensorOps::float_div).
    /// Int => [div](deepcode_tensor::ops::IntTensorOps::int_div).
    Div(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [div scalar](deepcode_tensor::ops::FloatTensorOps::float_div_scalar).
    /// Int => [div scalar](deepcode_tensor::ops::IntTensorOps::int_div_scalar).
    DivScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [rem](deepcode_tensor::ops::FloatTensorOps::float_remainder).
    /// Int => [rem](deepcode_tensor::ops::IntTensorOps::int_remainder).
    Rem(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [rem scalar](deepcode_tensor::ops::FloatTensorOps::float_remainder_scalar).
    /// Int => [rem scalar](deepcode_tensor::ops::IntTensorOps::int_remainder_scalar).
    RemScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mul](deepcode_tensor::ops::FloatTensorOps::float_mul).
    /// Int => [mul](deepcode_tensor::ops::IntTensorOps::int_mul).
    Mul(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mul scalar](deepcode_tensor::ops::FloatTensorOps::float_mul_scalar).
    /// Int => [mul scalar](deepcode_tensor::ops::IntTensorOps::int_mul_scalar).
    MulScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [abs](deepcode_tensor::ops::FloatTensorOps::float_abs).
    /// Int => [abs](deepcode_tensor::ops::IntTensorOps::int_abs).
    Abs(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [ones](deepcode_tensor::ops::FloatTensorOps::float_ones).
    /// Int => [ones](deepcode_tensor::ops::IntTensorOps::int_ones).
    Ones(TensorIr),
    /// Operation corresponding to:
    ///
    /// Float => [zeros](deepcode_tensor::ops::FloatTensorOps::float_zeros).
    /// Int => [zeros](deepcode_tensor::ops::IntTensorOps::int_zeros).
    Zeros(TensorIr),
    /// Operation corresponding to:
    ///
    /// Float => [full](deepcode_tensor::ops::FloatTensorOps::float_full).
    /// Int => [full](deepcode_tensor::ops::IntTensorOps::int_full).
    Full((TensorIr, ScalarIr)),
    /// Operation corresponding to:
    ///
    /// Float => [gather](deepcode_tensor::ops::FloatTensorOps::float_gather).
    /// Int => [gather](deepcode_tensor::ops::IntTensorOps::int_gather).
    Gather(GatherOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [scatter](deepcode_tensor::ops::FloatTensorOps::float_scatter).
    /// Int => [scatter](deepcode_tensor::ops::IntTensorOps::int_scatter).
    Scatter(ScatterOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [select](deepcode_tensor::ops::FloatTensorOps::float_select).
    /// Int => [select](deepcode_tensor::ops::IntTensorOps::int_select).
    Select(SelectOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [select assign](deepcode_tensor::ops::FloatTensorOps::float_select_assign).
    /// Int => [select assign](deepcode_tensor::ops::IntTensorOps::int_select_assign).
    SelectAssign(SelectAssignOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mask where](deepcode_tensor::ops::FloatTensorOps::float_mask_where).
    /// Int => [mask where](deepcode_tensor::ops::IntTensorOps::int_mask_where).
    MaskWhere(MaskWhereOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mask fill](deepcode_tensor::ops::FloatTensorOps::float_mask_fill).
    /// Int => [mask fill](deepcode_tensor::ops::IntTensorOps::int_mask_fill).
    MaskFill(MaskFillOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mean dim](deepcode_tensor::ops::FloatTensorOps::float_mean_dim).
    /// Int => [mean dim](deepcode_tensor::ops::IntTensorOps::int_mean_dim).
    MeanDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mean](deepcode_tensor::ops::FloatTensorOps::float_mean).
    /// Int => [mean](deepcode_tensor::ops::IntTensorOps::int_mean).
    Mean(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sum](deepcode_tensor::ops::FloatTensorOps::float_sum).
    /// Int => [sum](deepcode_tensor::ops::IntTensorOps::int_sum).
    Sum(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sum dim](deepcode_tensor::ops::FloatTensorOps::float_sum_dim).
    /// Int => [sum dim](deepcode_tensor::ops::IntTensorOps::int_sum_dim).
    SumDim(ReduceDimOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [prod](deepcode_tensor::ops::FloatTensorOps::float_prod).
    /// Int => [prod](deepcode_tensor::ops::IntTensorOps::int_prod).
    Prod(UnaryOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [prod dim](deepcode_tensor::ops::FloatTensorOps::float_prod_dim).
    /// Int => [prod dim](deepcode_tensor::ops::IntTensorOps::int_prod_dim).
    ProdDim(ReduceDimOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [equal elem](deepcode_tensor::ops::FloatTensorOps::float_equal_elem).
    /// Int => [equal elem](deepcode_tensor::ops::IntTensorOps::int_equal_elem).
    EqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater](deepcode_tensor::ops::FloatTensorOps::float_greater).
    /// Int => [greater](deepcode_tensor::ops::IntTensorOps::int_greater).
    Greater(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater elem](deepcode_tensor::ops::FloatTensorOps::float_greater_elem).
    /// Int => [greater elem](deepcode_tensor::ops::IntTensorOps::int_greater_elem).
    GreaterElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater equal](deepcode_tensor::ops::FloatTensorOps::float_greater_elem).
    /// Int => [greater elem](deepcode_tensor::ops::IntTensorOps::int_greater_elem).
    GreaterEqual(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater equal elem](deepcode_tensor::ops::FloatTensorOps::float_greater_equal_elem).
    /// Int => [greater equal elem](deepcode_tensor::ops::IntTensorOps::int_greater_equal_elem).
    GreaterEqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower](deepcode_tensor::ops::FloatTensorOps::float_lower).
    /// Int => [lower](deepcode_tensor::ops::IntTensorOps::int_lower).
    Lower(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower elem](deepcode_tensor::ops::FloatTensorOps::float_lower_elem).
    /// Int => [lower elem](deepcode_tensor::ops::IntTensorOps::int_lower_elem).
    LowerElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower equal](deepcode_tensor::ops::FloatTensorOps::float_lower_equal).
    /// Int => [lower equal](deepcode_tensor::ops::IntTensorOps::int_lower_equal).
    LowerEqual(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower equal elem](deepcode_tensor::ops::FloatTensorOps::float_lower_equal_elem).
    /// Int => [lower equal elem](deepcode_tensor::ops::IntTensorOps::int_lower_equal_elem).
    LowerEqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [argmax](deepcode_tensor::ops::FloatTensorOps::float_argmax).
    /// Int => [argmax](deepcode_tensor::ops::IntTensorOps::int_argmax).
    ArgMax(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [argmin](deepcode_tensor::ops::FloatTensorOps::float_argmin).
    /// Int => [argmin](deepcode_tensor::ops::IntTensorOps::int_argmin).
    ArgMin(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max](deepcode_tensor::ops::FloatTensorOps::float_max).
    /// Int => [max](deepcode_tensor::ops::IntTensorOps::int_max).
    Max(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max dim with indices](deepcode_tensor::ops::FloatTensorOps::float_max_dim_with_indices).
    /// Int => [max dim with indices](deepcode_tensor::ops::IntTensorOps::int_max_dim_with_indices).
    MaxDimWithIndices(ReduceDimWithIndicesOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min dim with indices](deepcode_tensor::ops::FloatTensorOps::float_min_dim_with_indices).
    /// Int => [min dim with indices](deepcode_tensor::ops::IntTensorOps::int_min_dim_with_indices).
    MinDimWithIndices(ReduceDimWithIndicesOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min](deepcode_tensor::ops::FloatTensorOps::float_min).
    /// Int => [min](deepcode_tensor::ops::IntTensorOps::int_min).
    Min(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max dim](deepcode_tensor::ops::FloatTensorOps::float_max_dim).
    /// Int => [max dim](deepcode_tensor::ops::IntTensorOps::int_max_dim).
    MaxDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min dim](deepcode_tensor::ops::FloatTensorOps::float_min_dim).
    /// Int => [min dim](deepcode_tensor::ops::IntTensorOps::int_min_dim).
    MinDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max_abs](deepcode_tensor::ops::FloatTensorOps::float_max_abs).
    /// Int => [max_abs](deepcode_tensor::ops::IntTensorOps::int_max_abs).
    MaxAbs(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max_abs dim](deepcode_tensor::ops::FloatTensorOps::float_max_abs_dim).
    /// Int => [max_abs dim](deepcode_tensor::ops::IntTensorOps::int_max_abs_dim).
    MaxAbsDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [clamp](deepcode_tensor::ops::FloatTensorOps::float_clamp).
    /// Int => [clamp](deepcode_tensor::ops::IntTensorOps::int_clamp).
    Clamp(ClampOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [random](deepcode_tensor::ops::IntTensorOps::int_random).
    IntRandom(RandomOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [powf](deepcode_tensor::ops::FloatTensorOps::float_powf).
    /// Int => [powf](deepcode_tensor::ops::IntTensorOps::int_powf).
    Powf(BinaryOpIr),
}
...
pub enum IntOperationIr {
    /// Operation corresponding to [into float](deepcode_tensor::ops::IntTensorOps::int_into_float).
    IntoFloat(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise and](deepcode_tensor::ops::IntTensorOps::bitwise_and).
    BitwiseAnd(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise and scalar](deepcode_tensor::ops::IntTensorOps::bitwise_and_scalar).
    BitwiseAndScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise or](deepcode_tensor::ops::IntTensorOps::bitwise_or).
    BitwiseOr(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise or scalar](deepcode_tensor::ops::IntTensorOps::bitwise_or_scalar).
    BitwiseOrScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise xor](deepcode_tensor::ops::IntTensorOps::bitwise_xor).
    BitwiseXor(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise xor scalar](deepcode_tensor::ops::IntTensorOps::bitwise_xor_scalar).
    BitwiseXorScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise not](deepcode_tensor::ops::IntTensorOps::bitwise_not).
    BitwiseNot(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise left shift](deepcode_tensor::ops::IntTensorOps::bitwise_left_shift).
    BitwiseLeftShift(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise left shift scalar](deepcode_tensor::ops::IntTensorOps::bitwise_left_shift_scalar).
    BitwiseLeftShiftScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise right shift](deepcode_tensor::ops::IntTensorOps::bitwise_right_shift).
    BitwiseRightShift(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise right shift scalar](deepcode_tensor::ops::IntTensorOps::bitwise_right_shift_scalar).
    BitwiseRightShiftScalar(ScalarOpIr),
    /// Operation corresponding to [matmul](deepcode_tensor::ops::IntTensorOps::int_matmul).
    Matmul(BinaryOpIr),
}
...
pub enum BoolOperationIr {
    /// Operation corresponding to:
    /// [ones](deepcode_tensor::ops::BoolTensorOps::bool_zeros).
    Zeros(TensorIr),
    /// Operation corresponding to:
    /// [ones](deepcode_tensor::ops::BoolTensorOps::bool_ones).
    Ones(TensorIr),
    /// Operation corresponding to [into float](deepcode_tensor::ops::BoolTensorOps::bool_into_float).
    IntoFloat(UnaryOpIr),
    /// Operation corresponding to [into int](deepcode_tensor::ops::BoolTensorOps::bool_into_int).
    IntoInt(UnaryOpIr),
    /// Operation corresponding to [not](deepcode_tensor::ops::BoolTensorOps::bool_not).
    Not(UnaryOpIr),
    /// Operation corresponding to [and](deepcode_tensor::ops::BoolTensorOps::bool_and).
    And(BinaryOpIr),
    /// Operation corresponding to [or](deepcode_tensor::ops::BoolTensorOps::bool_or).
    Or(BinaryOpIr),
}
...
pub struct SliceAssignOpIr {
    pub tensor: TensorIr,
    pub ranges: Vec<deepcode_tensor::Slice>,
    pub value: TensorIr,
    pub out: TensorIr,
}
