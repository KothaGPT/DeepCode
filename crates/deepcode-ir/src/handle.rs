...
impl<H: Clone> HandleContainer<H> {
    ...
    /// Get the [float tensor](deepcode_tensor::backend::Backend::FloatTensorPrimitive) corresponding to the
    ...
    /// Get the [int tensor](deepcode_tensor::backend::Backend::IntTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [bool tensor](deepcode_tensor::backend::Backend::BoolTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [quantized tensor](deepcode_tensor::backend::Backend::QuantizedTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Register a new [float tensor](deepcode_tensor::backend::Backend::FloatTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [quantized tensor](deepcode_tensor::backend::Backend::QuantizedTensorPrimitive) with the corresponding [tensor ids](TensorId).
    ...
    /// Register a new [int tensor](deepcode_tensor::backend::Backend::IntTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [bool tensor](deepcode_tensor::backend::Backend::BoolTensorPrimitive) with the corresponding [tensor id](TensorId).
