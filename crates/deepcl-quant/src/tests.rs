use deepcl::prelude::*;
use deepcl_core::Runtime;
use deepcl_core::server::CopyDescriptor;
use deepcl_core::{self as deepcl, server::AllocationDescriptor};
    ...
    let [output_alloc, output_scale_alloc] = client
        .empty_tensors(vec![
            AllocationDescriptor {
                kind: deepcl_core::server::AllocationKind::Contiguous,
                shape: &shape_out,
...
macro_rules! testgen_quant {
    ...
    ($shape_x: expr, $shape_y: expr) => {
        mod q8f {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q8F, $shape_x, $shape_y);
        }
        mod q8s {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q8S, $shape_x, $shape_y);
        }
        mod q4f {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q4F, $shape_x, $shape_y);
        }
        mod q4s {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q4S, $shape_x, $shape_y);
        }
        mod q2f {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q2F, $shape_x, $shape_y);
        }
        mod q2s {
            use super::*;
            deepcl_quant::testgen_quant!(QuantValue::Q2S, $shape_x, $shape_y);
        }
    };
    () => {
        mod quant {
            ...
            use deepcl_quant::scheme::{QuantMode, QuantValue};

            mod size32x32 {
                use super::*;
                deepcl_quant::testgen_quant!(32, 32);
            }
            mod size16x64 {
                use super::*;
                deepcl_quant::testgen_quant!(16, 64);
            }
        }
    };
}
