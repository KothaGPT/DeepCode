use deepcl::calculate_cube_count_elemwise;
use deepcl::prelude::*;
use deepcl_common::{e2m1x2, e4m3, e5m2, ue8m0};
use deepcl_core::tensor_line_size_parallel;
use deepcl_core::{self as deepcl};
use deepcl_runtime::TypeUsage;
use deepcl_std::tensor::layout::linear::LinearView;
use deepcl_std::tensor::{View, layout::linear::linear_view};
