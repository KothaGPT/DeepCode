...
/// Configuration for memory settings in DeepCL.
...
/// Configuration options for persistent memory pools in DeepCL runtimes.
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize, Default)]
...
/// Log levels for memory-related events in DeepCL.
