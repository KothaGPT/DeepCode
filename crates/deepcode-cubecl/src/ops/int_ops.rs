...
use deepcode_tensor::ops::{BoolTensor, Device, FloatTensor, IntElem, IntTensor};
use deepcode_tensor::{DType, IntDType};
use deepcode_tensor::{Distribution, ElementConversion, Shape, TensorData, ops::IntTensorOps};
use deepcl::frontend::Numeric;
use deepcl::prelude::*;
use deepcl::reduce::ReducePrecision;
use deepcl::reduce::instructions::ReduceFnConfig;
use std::ops::Range;
