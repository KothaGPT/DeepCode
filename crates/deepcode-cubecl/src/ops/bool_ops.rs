...
use deepcode_tensor::ops::{BoolTensor, BoolTensorOps, Device, FloatTensor, IntTensor};
use deepcode_tensor::{Shape, TensorData};
use std::ops::Range;
    ...
    BT: BoolElement,
{
    ...
    fn bool_slice(tensor: BoolTensor<Self>, slices: &[deepcode_tensor::Slice]) -> BoolTensor<Self> {
