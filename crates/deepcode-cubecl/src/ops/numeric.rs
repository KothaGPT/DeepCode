...
use deepcode_tensor::{ElementConversion, Shape};
use deepcl::std::tensor::layout::linear::LinearView;
use deepcl::{calculate_cube_count_elemwise, prelude::*};
use deepcl::{client::ComputeClient, server::Allocation};
...
/// # TODO
///
/// Implement an efficient GPU-optimized parallel scan algorithm (deepcl-scan crate).
/// See draft PR: https://github.com/tracel-ai/deepcl/pull/863
///
/// References:
