...
use deepcode_tensor::ops::{BoolTensor, Device, FloatElem, FloatTensor, IntTensor};
use deepcode_tensor::{DType, ElementConversion, FloatDType};
use deepcode_tensor::{Distribution, Shape, TensorData, ops::FloatTensorOps};
use deepcl::prelude::*;
