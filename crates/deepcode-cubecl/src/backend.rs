...
use deepcode_tensor::backend::{Backend, DeviceOps};
use deepcl::server::ComputeServer;
...
#[cfg(not(feature = "fusion"))]
use deepcode_tensor::ops::{BoolTensor, FloatTensor, IntTensor, QuantizedTensor};
...
where
    ...
    R::Device: deepcode_tensor::backend::DeviceOps,
    F: FloatElement,
    I: IntElement,
    BT: BoolElement,
{
...
impl<R: deepcl::Runtime> CubeRuntime for R
where
    R::Device: DeviceOps,
{
