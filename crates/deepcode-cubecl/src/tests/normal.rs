#[deepcode_tensor_testgen::testgen(normal)]
mod tests {
    use super::*;
    use deepcode_tensor::{Distribution, Shape, Tensor, TensorData, backend::Backend};
    use deepcode_tensor::{Tolerance, ops::FloatElem};
    use deepcl::random::{assert_mean_approx_equal, assert_normal_respects_68_95_99_rule};
