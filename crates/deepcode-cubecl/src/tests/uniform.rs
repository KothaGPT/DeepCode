#[deepcode_tensor_testgen::testgen(uniform)]
mod tests {
    use super::*;
    use core::f32;

    use deepcode_tensor::{Distribution, Int, Shape, Tensor, backend::Backend, ops::IntTensorOps};
    use deepcode_tensor::{ElementConversion, Tolerance, ops::FloatElem};
    type FT = FloatElem<TestBackend>;

    use serial_test::serial;

    use deepcl::random::{assert_at_least_one_value_per_bin, assert_wald_wolfowitz_runs_test};
