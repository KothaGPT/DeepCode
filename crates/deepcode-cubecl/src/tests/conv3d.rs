#[deepcode_tensor_testgen::testgen(conv3d)]
mod tests {
    use super::*;
    use deepcode_tensor::{Distribution, Tensor, module};
    ...
    fn conv3d_should_match_reference_backend() {
        ...
        let options = deepcode_tensor::ops::ConvOptions::new([2, 3, 4], [2, 3, 4], [2, 3, 4], 2);
