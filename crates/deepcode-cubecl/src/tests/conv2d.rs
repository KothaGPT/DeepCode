#[deepcode_tensor_testgen::testgen(conv2d)]
mod tests {
    use super::*;
    use deepcode_deepcl::{
    ...
    use deepcode_tensor::{Distribution, Tensor, backend::Backend, module};
    ...
    fn conv2d_should_match_reference_backend() {
        ...
        let options = deepcode_tensor::ops::ConvOptions::new([2, 3], [2, 3], [2, 3], 2);
    ...
    fn conv2d_should_match_reference_backend_implicit() {
        ...
        let options = deepcode_tensor::ops::ConvOptions::new([1, 1], [2, 2], [1, 1], 1);
    ...
    fn conv2d_should_match_reference_backend_bias_regression() {
        ...
        let options = deepcode_tensor::ops::ConvOptions::new([1, 1], [1, 1], [1, 1], 1);
