#[deepcode_tensor_testgen::testgen(mask_where)]
mod tests {
    use super::*;
    use deepcode_deepcl::kernel::{MaskWhereStrategy, mask_where};
    use deepcode_tensor::{Bool, Distribution, Tensor, TensorPrimitive, backend::Backend};
