...
mod reduce_ops {
    ...
    use deepcl::reduce::ReduceFamily;
    ...
    >(
        ...
        deepcl::reduce::reduce::<Run, (In, Acc), Out, Rd>(
            &input.client,
            input.as_handle_ref(),
            output.as_handle_ref(),
            axis,
            Some(deepcl::reduce::ReduceStrategy {
                shared: false,
                use_planes: false,
            }),
            config,
...
mod sum_ops {
    ...
    pub(crate) fn sum_one_shot<Run: CubeRuntime, E: CubeElement, const C: u32>(
        ...
        deepcl::reduce::shared_sum::<Run, E>(
            &input.client,
            input.as_handle_ref(),
            output.as_handle_ref(),
            C,
    ...
    pub(crate) fn sum_chained<Run: CubeRuntime, E: CubeElement>(
        ...
        crate::kernel::reduce::reduce::<Run, E, E, E>(
            ...
            deepcl::reduce::instructions::ReduceFnConfig::Sum,
        )
        .map_err(|e| e.to_string())
    }
}
