use deepcode_tensor::ops::{ConvOptions, conv::calculate_conv_output_sizes};
use deepcl::{
    convolution::{
        ConvolutionArgs,
...
/// Perform a 2D convolution using the implicit GEMM (im2col) algorithm, using deepcl tiling matmul
