...
use core::iter;
#[cfg(test)]
use deepcl::convolution::components::ConvSetupError;
#[cfg(not(test))]
use deepcl::convolution::components::ConvSetupError;
use deepcl::std::{FastDivmod, FastDivmodArgs};
use deepcl::{
...
pub(crate) fn batches_per_run(
    ...
    use deepcl::matmul::components::MatmulAvailabilityError;

    let cube_count_per_batch = out_shape.div_ceil(deepcl::PLANE_DIM_APPROX);
