...
use deepcl::{calculate_cube_count_elemwise, prelude::*, std::tensor::layout::linear::LinearView};
...
/// float.
///
/// Because of this we won't benefit from the deepcl rust compilation speed improvement from using
