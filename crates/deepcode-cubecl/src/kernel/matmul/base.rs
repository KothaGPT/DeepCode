...
use deepcode_tensor::{DType, quantization::QuantAcc};
use deepcl::matmul::{
...
pub fn q_matmul<R: CubeRuntime>(
    ...
    match QuantAcc::default() {
        QuantAcc::F32 => {
            deepcl::matmul::launch_ref::<R, (i8, i8, half::f16, half::f16, f32, half::f16)>(
                &Default::default(),
                client,
        ...
        QuantAcc::F16 => {
            deepcl::matmul::launch_ref::<R, (i8, i8, half::f16, half::f16, half::f16, half::f16)>(
                &Default::default(),
                client,
                &MatmulInputHandleRef::Quantized {
                    data: lhs.as_handle_ref(),
