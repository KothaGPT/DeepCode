mod tests {
    ...
    use deepcode_tensor::{Shape, Tensor, TensorData, TensorPrimitive, Tolerance, backend::Backend};
    ...
    pub type TestBackend = deepcode_cuda::Cuda<f32>;

    #[cfg(feature = "test-wgpu")]
    pub type TestBackend = deepcode_wgpu::Wgpu<f32>;
