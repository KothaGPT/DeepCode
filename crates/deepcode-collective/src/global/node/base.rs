use deepcode_communication::Protocol;
use deepcode_communication::data_service::TensorDataServer;
use deepcode_communication::{Address, ProtocolServer, data_service::TensorDataService};
use deepcode_tensor::{ElementConversion, backend::Backend};
