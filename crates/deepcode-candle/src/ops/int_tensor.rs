...
impl<F: FloatCandleElement, I: IntCandleElement> IntTensorOps<Self> for Candle<F, I> {
    ...
    fn int_from_data(data: TensorData, device: &Device<Self>) -> IntTensor<Self> {
        match data.dtype {
            deepcode_tensor::DType::I64 => super::base::from_data::<i64>(data, device),
            deepcode_tensor::DType::U32 => super::base::from_data::<u32>(data, device),
            deepcode_tensor::DType::U8 => super::base::from_data::<u8>(data, device),
    ...
    fn int_slice(tensor: IntTensor<Self>, slices: &[deepcode_tensor::Slice]) -> IntTensor<Self> {
        super::base::slice_with_steps(tensor, slices)
    }

    fn int_slice_assign(
        tensor: IntTensor<Self>,
        slices: &[deepcode_tensor::Slice],
    ...
    fn int_prod(tensor: IntTensor<Self>) -> IntTensor<Self> {
        todo!(
            "prod is not implemented for Candle IntTensor (see https://github.com/kothagpt/deepcode/issues/1454)"
        )
    }

    fn int_prod_dim(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        todo!(
            "prod_int is not implemented for Candle IntTensor (see https://github.com/kothagpt/deepcode/issues/1454)"
        )
    }
