...
impl<F: FloatCandleElement, I: IntCandleElement> FloatTensorOps<Self> for Candle<F, I> {
    fn float_from_data(data: TensorData, device: &Device<Self>) -> CandleTensor {
        match data.dtype {
            deepcode_tensor::DType::F64 => super::base::from_data::<f64>(data, device),
            deepcode_tensor::DType::F32 => super::base::from_data::<f32>(data, device),
            deepcode_tensor::DType::F16 => super::base::from_data::<f16>(data, device),
            deepcode_tensor::DType::BF16 => super::base::from_data::<bf16>(data, device),
