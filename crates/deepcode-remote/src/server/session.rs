use deepcode_common::id::StreamId;
use deepcode_communication::{Protocol, data_service::TensorDataService};
use deepcode_ir::BackendIr;
use deepcode_router::Runner;
use deepcode_tensor::Device;
