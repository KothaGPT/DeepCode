...
use deepcode_fusion::stream::{Context, ContextOwned};
use deepcl::Runtime;
...
/// # Safety
///
/// This should only be used with the [tuner](deepcl::tune::LocalTuner), since safety assumptions
...
/// [deepcl::tune::LocalTuner::execute] function. This is the case, since autotune functions are
