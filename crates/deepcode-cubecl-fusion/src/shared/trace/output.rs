use deepcode_common::tensor::{ReshapeAction, contiguous_strides, is_contiguous, reshape_action};
use deepcode_fusion::stream::Context;
use deepcode_ir::{TensorId, TensorIr};
use deepcode_tensor::DType;
use deepcl::{CubeElement, Runtime, client::ComputeClient, ir::StorageType};
