...
use deepcode_fusion::stream::Context;
use deepcode_ir::BinaryOpIr;
use deepcode_ir::TensorId;
use deepcode_ir::TensorIr;
use deepcl::features::TypeUsage;
use deepcl::matmul::components::AccG;
use deepcl::matmul::components::AccS;
use deepcl::matmul::components::tile::io::Filled;
use deepcl::matmul::kernels::layered::Selection;
use deepcl::matmul::kernels::layered::double_buffering::CyclicDoubleBufferingAlgorithm;
use deepcl::matmul::kernels::layered::double_buffering::DoubleBufferingArgs;
use deepcl::matmul::kernels::layered::double_unit::DoubleUnitAlgorithm;
use deepcl::matmul::kernels::layered::launch_kernel_virtual;
use deepcl::matmul::kernels::layered::ordered_double_buffering::OrderedDoubleBufferingAlgorithm;
use deepcl::matmul::kernels::layered::ordered_double_buffering::OrderedSelectionArgs;
use deepcl::matmul::kernels::layered::simple::SimpleAlgorithm;
use deepcl::matmul::kernels::layered::simple::SimpleArgs;
use deepcl::matmul::kernels::layered::simple_unit::SimpleUnitAlgorithm;
use deepcl::matmul::kernels::layered::vecmat::DoubleVecMatAlgorithm;
use deepcl::matmul::kernels::layered::vecmat::SimpleVecMatAlgorithm;
use deepcl::matmul::{
    components::{LhsS, MatmulLineSizes, MatmulPrecision},
    kernels::layered::Algorithm,
};
use deepcl::std::tensor::{MatrixBatchLayout, matrix_batch_layout};
use deepcl::{client::ComputeClient, prelude::*};
use deepcl::{
    matmul::components::{
    ...
    pub fn execute_fallback<BT: CubeElement>(
        ...
        if let TuneOutput::Checked { handles } = &mut output {
            ...
            let handle_out = context
                .handles
                .get_handle(&out_desc.id, &deepcode_ir::TensorStatus::ReadOnly);
