The `deepcode-no-std-tests` contains integration tests aimed to check `no_std` compatibility of `deepcode`, `deepcode-core`, `deepcode-tensor` and `deepcode-ndarray` packages.
