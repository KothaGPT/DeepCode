...
use deepcode_core::tensor::backend::Backend;
use deepcode_core::tensor::{ElementConversion, Int, Tensor};
...
impl<B: Backend> Metric for PerplexityMetric<B> {
    ...
    fn update(&mut self, input: &PerplexityInput<B>, _metadata: &MetricMetadata) -> MetricEntry {
        ...
        let log_probs = deepcode_core::tensor::activation::log_softmax(outputs, 1);
