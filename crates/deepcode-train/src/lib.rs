...
//! A library for training neural networks using the deepcode crate.
...
#[cfg(test)]
pub(crate) type TestBackend = deepcode_ndarray::NdArray<f32>;

#[cfg(test)]
pub(crate) mod tests {
    use crate::TestBackend;
    use deepcode_core::{prelude::Tensor, tensor::Bool};
