...
use deepcode_collective::{self, CollectiveConfig, PeerId};
use deepcode_core::module::Module;
use deepcode_core::prelude::Backend;
    ...
    LC: LearnerComponentTypes + Send + 'static,
{
    ...
    pub fn fit(mut self) -> LC::Model {
        deepcode_collective::register::<<LC::Backend as AutodiffBackend>::InnerBackend>(
            self.peer_id,
            self.device.clone(),
