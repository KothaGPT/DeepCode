...
use deepcode_core::module::AutodiffModule;
use deepcode_core::record::FileRecorder;
use deepcode_core::tensor::backend::AutodiffBackend;
use deepcode_optim::Optimizer;
use deepcode_optim::lr_scheduler::LrScheduler;
    ...
    VO: ItemLazy + 'static,
{
    ...
    /// [learning rate](deepcode_optim::LearningRate).
