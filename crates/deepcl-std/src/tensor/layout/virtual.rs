...
use deepcl::prelude::*;
use deepcl_core::{self as deepcl, intrinsic, ir::Scope, unexpanded};
...
mod launch {
    ...
    impl<'a, C: Coordinates, S: Coordinates, R: deepcl::prelude::Runtime>
    ...
    impl<'a, C: Coordinates, S: Coordinates, R: deepcl::prelude::Runtime> ArgSettings<R>
        for VirtualLayoutLaunch<'a, C, S, R>
    {
        fn register(&self, launcher: &mut deepcl::prelude::KernelLauncher<R>) {
