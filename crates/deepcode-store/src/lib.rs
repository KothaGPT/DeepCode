...
//! # Deepcode Store
//!
//! Advanced model storage and serialization infrastructure for the Deepcode deep learning framework.
//!
//! This crate provides comprehensive functionality for storing and loading Deepcode modules
...
//! - **PyTorch Compatibility**: Load PyTorch models directly into Deepcode with automatic weight transformation
...
//!
//! ```rust,ignore
//! use deepcode_store::PytorchStore;
//!
//! // Load PyTorch model (automatic weight transformation via PyTorchToDeepcodeAdapter)
...
//!
//! ```rust,ignore
//! use deepcode_store::SafetensorsStore;
//!
...
//! ## Core Components
//!
//! - [`ModuleSnapshot`]: Extension trait for Deepcode modules providing `collect()` and `apply()` methods
...
pub use adapter::{DeepcodeToPyTorchAdapter, IdentityAdapter, ModuleAdapter, PyTorchToDeepcodeAdapter};
