...
use deepcode_tensor::{Bool, Int, Tensor, backend::Backend};

use crate::{ModuleAdapter, PathFilter, TensorSnapshot};
use deepcode_core::module::{ModuleVisitor, ParamId};
...
impl Collector {
    ...
    ///
    /// ```rust,ignore
    /// use deepcode_store::{Collector, PathFilter};
    ///
