...
use deepcode_core::module::{ModuleMapper, ParamId};
use deepcode_tensor::{Bool, DType, Int, Tensor, backend::Backend};
...
impl<B: Backend> Applier<B> {
    ...
    where
        K: deepcode_tensor::TensorKind<B>,
        K: deepcode_tensor::BasicOps<B>,
    {
