...
fn multi_layer_model_import() {
    ...
    // Note: PyTorch and Deepcode have different conventions for linear layer weights
    // PyTorch stores as [out_features, in_features], Deepcode as [in_features, out_features]
    ...
    // Note: Due to shape mismatches (PyTorch vs Deepcode conventions for linear layers),
