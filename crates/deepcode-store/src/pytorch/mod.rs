//! PyTorch format support for deepcode-store.
//!
//! This module provides comprehensive support for loading PyTorch model files (.pth, .pt)
//! into Deepcode, with automatic weight transformation and flexible configuration options.
//!
//! ## Features
//!
//! - **Direct .pth/.pt file loading**: Load PyTorch checkpoint and state dict files
//! - **Automatic weight transformation**: `PyTorchToDeepcodeAdapter` is applied by default:
...
//!
//! // Load a PyTorch model (PyTorchToDeepcodeAdapter is applied automatically)
