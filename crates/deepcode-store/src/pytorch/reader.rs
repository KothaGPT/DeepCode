...
use alloc::vec::Vec;
use deepcode_core::record::serde::{adapter::DefaultAdapter, data::NestedValue, de::Deserializer};
...
pub enum PytorchError {
    ...
    Serde(deepcode_core::record::serde::error::Error),
}
...
impl From<deepcode_core::record::serde::error::Error> for PytorchError {
    fn from(e: deepcode_core::record::serde::error::Error) -> Self {
