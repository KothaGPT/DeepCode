...
///
/// This trait provides convenient methods to collect and apply tensor snapshots from any Deepcode module.
...
pub trait ModuleSnapshot<B: Backend>: Module<B> {
        ...
        Self: Sized,
    {
        ...
        // See https://github.com/kothagpt/deepcode/issues/3754
        unsafe {
