...
use deepcode_core::module::Module;
use deepcode_core::prelude::*;
use deepcode_core::record::{FullPrecisionSettings, Recorder};
use deepcode_import::pytorch::{LoadArgs, PyTorchFileRecorder};
use deepcode_import::safetensors::SafetensorsFileRecorder;
use deepcode_nn as nn;
use deepcode_store::{ModuleSnapshot, PyTorchToDeepcodeAdapter, PytorchStore, SafetensorsStore};
...
type NdArrayBackend = deepcode_ndarray::NdArray<f32>;

#[cfg(feature = "wgpu")]
type WgpuBackend = deepcode_wgpu::Wgpu;

#[cfg(feature = "cuda")]
type CudaBackend = deepcode_cuda::Cuda<f32, i32>;

#[cfg(feature = "candle")]
type CandleBackend = deepcode_candle::Candle<f32, i64>;

#[cfg(feature = "tch")]
type TchBackend = deepcode_tch::LibTorch<f32>;

#[cfg(feature = "metal")]
type MetalBackend = deepcode_metal::Metal;
