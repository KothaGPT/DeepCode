...
use deepcode::module::{Module, Quantizer};
use deepcode::tensor::{
...
pub type B = deepcode_ndarray::NdArray<f32>;

#[cfg(all(test, feature = "test-wgpu"))]
/// Backend for test cases
pub type B = deepcode_wgpu::Wgpu;

#[cfg(all(test, feature = "test-cuda"))]
/// Backend for test cases
pub type B = deepcode_cuda::Cuda;

#[cfg(all(test, feature = "test-rocm"))]
/// Backend for test cases
pub type B = deepcode_rocm::Rocm;
