...
use alloc::vec::Vec;
use deepcode::module::{Content, DisplaySettings, ModuleDisplay};
use deepcode::tensor::activation::log_sigmoid;
use deepcode::tensor::{Int, Tensor, backend::Backend};
use deepcode::{config::Config, module::Module};
...
impl<B: Backend> BinaryCrossEntropyLoss<B> {
    ...
    pub fn forward<const D: usize>(
        ...
        let mut loss = if self.logits {
            ...
            // https://github.com/kothagpt/deepcode/issues/2739: clamp at -100.0 to avoid undefined values
...
mod tests {
    ...
    use deepcode::tensor::{TensorData, activation::sigmoid};
