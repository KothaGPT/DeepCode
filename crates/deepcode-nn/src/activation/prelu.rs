...
use deepcode::module::{Content, DisplaySettings, Initializer, Module, ModuleDisplay, Param};
...
impl<B: Backend> PRelu<B> {
    ...
    /// - output: `[..., any]`
    ///
    /// See also [prelu](deepcode::tensor::activation::prelu) for more information.
    pub fn forward<const D: usize>(&self, input: Tensor<B, D>) -> Tensor<B, D> {
        deepcode::tensor::activation::prelu(input, self.alpha.val())
    }
}
