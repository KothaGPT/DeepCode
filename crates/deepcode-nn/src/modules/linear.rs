...
use deepcode::module::Param;
use deepcode::module::{Content, DisplaySettings, Initializer, Module, ModuleDisplay};
use deepcode::tensor::module::linear;
use deepcode::tensor::{Tensor, backend::Backend};
...
mod tests {
    ...
    use deepcode::module::ParamId;
    use deepcode::record::{BinBytesRecorder, FullPrecisionSettings, Recorder};
    use deepcode::tensor::ElementConversion;
    use deepcode::tensor::{Shape, TensorData};
    use deepcode::tensor::{Tolerance, ops::FloatElem};
    ...
    fn col_row_same_result() {
        ...
        let signal = Tensor::<_, 2>::random([8, 6], deepcode::tensor::Distribution::Default, &device);
