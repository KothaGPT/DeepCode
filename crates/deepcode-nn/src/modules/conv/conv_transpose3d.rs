...
use deepcode::tensor::module::conv_transpose3d;
...
impl<B: Backend> ConvTranspose3d<B> {
    ...
    ///
    /// See also [conv_transpose3d](deepcode::tensor::module::conv_transpose3d).
    ///
    /// # Shapes
    ///
...
#[cfg(test)]
mod tests {
    use deepcode::tensor::{ElementConversion, Tolerance, ops::FloatElem};
