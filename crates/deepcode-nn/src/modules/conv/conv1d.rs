...
use deepcode::tensor::{Tensor, backend::Backend, module::conv1d, ops::ConvOptions};
use deepcode::{
    config::Config,
...
impl<B: Backend> Conv1d<B> {
    ...
    ///
    /// See [conv1d](deepcode::tensor::module::conv1d) for more information.
    ///
    /// # Shapes
    ///
...
#[cfg(test)]
mod tests {
    use deepcode::tensor::{ElementConversion, ops::FloatElem};
