use alloc::format;
use deepcode::tensor::ops::DeformConvOptions;
...
use deepcode::tensor::module::deform_conv2d;
...
impl<B: Backend> DeformConv2d<B> {
    ...
    ///
    /// See [deform_conv2d](deepcode::tensor::module::deform_conv2d) for more information.
    ///
    /// # Shapes
    ///
