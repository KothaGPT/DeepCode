...
use deepcode::module::Content;
use deepcode::module::DisplaySettings;
use deepcode::module::Initializer;
use deepcode::module::Module;
use deepcode::module::ModuleDisplay;
use deepcode::module::Param;
use deepcode::tensor::Tensor;
use deepcode::tensor::backend::Backend;
use deepcode::tensor::module::conv_transpose1d;
use deepcode::tensor::ops::ConvTransposeOptions;
...
impl<B: Backend> ConvTranspose1d<B> {
    ...
    ///
    /// See also [conv_transpose1d](deepcode::tensor::module::conv_transpose1d).
    ///
    /// # Shapes
    ///
...
mod tests {
    ...
    use deepcode::tensor::{ElementConversion, Tolerance};
