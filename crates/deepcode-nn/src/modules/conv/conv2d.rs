...
use deepcode::module::{Content, DisplaySettings, Ignored, Module, ModuleDisplay, Param};
use deepcode::tensor::Tensor;
use deepcode::tensor::backend::Backend;
use deepcode::tensor::module::conv2d;
use deepcode::tensor::ops::ConvOptions;
...
impl<B: Backend> Conv2d<B> {
    ...
    ///
    /// See [conv2d](deepcode::tensor::module::conv2d) for more information.
    ///
    /// # Shapes
    ...
    /// # Example
    /// ```rust,ignore
    /// use deepcode::nn::conv::Conv2dConfig;
    /// use deepcode::tensor::Tensor;
    ///
