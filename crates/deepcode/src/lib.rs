...
//! # Deepcode
//!
//! Deepcode is a new comprehensive dynamic Deep Learning Framework built using Rust
...
//! into useful intelligence, we have made performance a core pillar of Deepcode.
...
//!
//! Deepcode was built from the ground up with training and inference in mind. It's also worth noting how Deepcode,
...
//! ## Backends
//!
//! Deepcode strives to be as fast as possible on as many hardwares as possible, with robust implementations.
...
//!
//! Compared to other frameworks, Deepcode has a very different approach to supporting many backends.
//! By design, most code is generic over the Backend trait, which allows us to build Deepcode with swappable backends.
...
//!
//! Quantization support in Deepcode is currently in active development. It supports the following modes on some backends:
...
//!
//! You can also check the details in sub-crates [`deepcode-core`](https://docs.rs/deepcode-core) and [`deepcode-train`](https://docs.rs/deepcode-train).

pub use deepcode_core::*;

/// Train module
#[cfg(feature = "train")]
pub mod train {
    pub use deepcode_train::*;
}
...
#[cfg(feature = "server")]
pub use deepcode_remote::server;
...
/// Optimizers module.
pub mod optim {
    pub use deepcode_optim::*;
}

// For backward compat, `deepcode::lr_scheduler::*`
/// Learning rate scheduler module.
#[cfg(feature = "std")]
pub mod lr_scheduler {
    pub use deepcode_optim::lr_scheduler::*;
}
// For backward compat, `deepcode::grad_clipping::*`
/// Gradient clipping module.
pub mod grad_clipping {
    pub use deepcode_optim::grad_clipping::*;
}

/// DeepCL module re-export.
#[cfg(feature = "deepcl")]
pub mod deepcl {
    pub use deepcl::*;
}
