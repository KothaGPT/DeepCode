...
use deepcl_quant::scheme::{QuantStore, QuantValue};
use half::{bf16, f16};
use rand::RngCore;
...
#[cfg(feature = "deepcl")]
impl From<deepcl::ir::ElemType> for DType {
    fn from(value: deepcl::ir::ElemType) -> Self {
        match value {
            deepcl::ir::ElemType::Float(float_kind) => match float_kind {
                deepcl::ir::FloatKind::F16 => DType::F16,
                deepcl::ir::FloatKind::BF16 => DType::BF16,
                deepcl::ir::FloatKind::Flex32 => DType::Flex32,
                deepcl::ir::FloatKind::F32 => DType::F32,
                deepcl::ir::FloatKind::F64 => DType::F64,
                deepcl::ir::FloatKind::TF32 => panic!("Not a valid DType for tensors."),
                deepcl::ir::FloatKind::E2M1
                | deepcl::ir::FloatKind::E2M3
                | deepcl::ir::FloatKind::E3M2
                | deepcl::ir::FloatKind::E4M3
                | deepcl::ir::FloatKind::E5M2
                | deepcl::ir::FloatKind::UE8M0 => {
                    unimplemented!("Not yet supported, will be used for quantization")
                }
            },
            deepcl::ir::ElemType::Int(int_kind) => match int_kind {
                deepcl::ir::IntKind::I8 => DType::I8,
                deepcl::ir::IntKind::I16 => DType::I16,
                deepcl::ir::IntKind::I32 => DType::I32,
                deepcl::ir::IntKind::I64 => DType::I64,
            },
            deepcl::ir::ElemType::UInt(uint_kind) => match uint_kind {
                deepcl::ir::UIntKind::U8 => DType::U8,
                deepcl::ir::UIntKind::U16 => DType::U16,
                deepcl::ir::UIntKind::U32 => DType::U32,
                deepcl::ir::UIntKind::U64 => DType::U64,
            },
