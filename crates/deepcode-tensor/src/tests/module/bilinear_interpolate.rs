#[deepcode_tensor_testgen::testgen(module_bilinear_interpolate)]
mod tests {
    use super::*;
    use deepcode_tensor::module::interpolate;
    use deepcode_tensor::ops::{InterpolateMode, InterpolateOptions};
