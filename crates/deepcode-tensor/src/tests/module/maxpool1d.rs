#[deepcode_tensor_testgen::testgen(module_max_pool1d)]
mod tests {
    use super::*;
    use deepcode_tensor::module::{max_pool1d, max_pool1d_with_indices};
    use deepcode_tensor::{Tensor, TensorData, backend::Backend};
