#[deepcode_tensor_testgen::testgen(module_deform_conv2d)]
mod tests {

    use super::*;
    use deepcode_tensor::module::deform_conv2d;
    use deepcode_tensor::ops::{DeformConv2dBackward, DeformConvOptions, ModuleOps};
    use deepcode_tensor::{Shape, Tensor};
