#[deepcode_tensor_testgen::testgen(display)]
mod tests {
    use super::*;
    use deepcode_tensor::backend::Backend;
    use deepcode_tensor::{Element, PrintOptions, Shape, Tensor, TensorData, set_print_options};
    ...
    fn test_display_2d_int_tensor() {
        ...
        let tensor_int: deepcode_tensor::Tensor<TestBackend, 2, deepcode_tensor::Int> =
 ...
 [7, 8, 9]],
  ...
  dtype:  "{dtype}",
    ...
    fn test_display_2d_float_tensor() {
        ...
        let tensor_float: deepcode_tensor::Tensor<TestBackend, 2, deepcode_tensor::Float> =
 ...
 [7.7, 8.8, 9.9]],
  ...
  dtype:  "{dtype}",
    ...
    fn test_display_2d_bool_tensor() {
        ...
        let tensor_bool: deepcode_tensor::Tensor<TestBackend, 2, deepcode_tensor::Bool> =
 ...
 [false, true, true]],
  ...
  dtype:  {:?},
    ...
    fn test_display_3d_tensor() {
        ...
        let tensor: deepcode_tensor::Tensor<TestBackend, 3, deepcode_tensor::Int> =
 ...
 [[13, 14, 15, 16],
  ...
  dtype:  "{dtype}",
    ...
    fn test_display_4d_tensor() {
        ...
        let tensor: deepcode_tensor::Tensor<TestBackend, 4, deepcode_tensor::Int> =
            Tensor::from_data(data, &Default::default());
 ...
 [[[13, 14, 15],
  ...
  dtype:  "{dtype}",
    ...
    fn test_display_tensor_summarize_1() {
        let tensor: deepcode_tensor::Tensor<TestBackend, 4, deepcode_tensor::Float> =
