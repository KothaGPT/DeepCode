#[deepcode_tensor_testgen::testgen(primitive)]
mod tests {
    use super::*;
    use deepcode_tensor::{DType, Element, Shape, backend::Backend};
    ...
    fn should_support_float_dtype() {
        ...
        assert_eq!(
            deepcode_tensor::TensorMetadata::shape(&tensor),
            Shape::new([2, 3])
        );
        assert_eq!(
            deepcode_tensor::TensorMetadata::dtype(&tensor),
