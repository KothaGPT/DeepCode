#[deepcode_tensor_testgen::testgen(affine_grid)]
mod tests {
    use super::*;
    use deepcode_tensor::BasicOps;
    use deepcode_tensor::backend::Backend;
    use deepcode_tensor::grid::affine_grid_2d;
    use deepcode_tensor::{Int, Shape, Tensor, TensorData};
