...
use deepcode::{module::AutodiffModule, record::Record};

use deepcode::config::Config;
use deepcode::tensor::{Tensor, backend::AutodiffBackend};
use deepcode::tensor::{backend::Backend, ops::Device};
...
#[cfg(test)]
mod tests {
    use deepcode::tensor::Tolerance;
    use deepcode::tensor::ops::FloatElem;

    use super::*;
    use crate::TestAutodiffBackend;
    use crate::{GradientsParams, Optimizer};
    use deepcode::module::{Module, Param};
    use deepcode::tensor::{Distribution, Tensor, TensorData};
    use deepcode_nn::{Linear, LinearConfig, LinearRecord};
    ...
    fn test_adagrad_optimizer_save_load_state() {
        ...
        #[cfg(feature = "std")]
        {
            use deepcode::record::{BinFileRecorder, FullPrecisionSettings, Recorder};
        ...
        #[cfg(not(feature = "std"))]
        {
            use deepcode::record::{BinBytesRecorder, FullPrecisionSettings, Recorder};
