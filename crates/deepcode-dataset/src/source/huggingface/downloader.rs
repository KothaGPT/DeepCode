...
/// # Example
/// ```no_run
///  use deepcode_dataset::HuggingfaceDatasetLoader;
///  use deepcode_dataset::SqliteDataset;
...
impl HuggingfaceDatasetLoader {
    ...
    ///
    /// If not specified, the dataset will be stored in `~/.cache/deepcode-dataset`.
    ...
    /// Specify whether or not to use the deepcode-dataset Python
