...
//! ## Usage Example
//! ```rust
//! use deepcode_dataset::vision::CifarDataset;
//! use deepcode_dataset::vision::CifarType;
//!
...
use deepcode_common::network::downloader;
...
fn download(cifar_type: &CifarType) -> PathBuf {
    ...
    // Dataset files are stored in the deepcode-dataset cache directory
