...
// TODO: lift/unify `deepcode::tensor::indexing` to `deepcode::core:indexing`; move this there.
#[inline(always)]
    ...
    I: Clone + Send + Sync,
{
    ...
    // TODO: SliceArg in deepcode-tensor should be lifted to deepcode-common; this should use SliceArg.
