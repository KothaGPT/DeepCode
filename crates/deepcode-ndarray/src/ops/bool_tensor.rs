...
use alloc::vec;
use alloc::vec::Vec;
use deepcode_tensor::ops::{BoolTensorOps, FloatTensor, IntTensorOps};
use deepcode_tensor::{ElementConversion, TensorMetadata};
...
// Workspace crates
use deepcode_tensor::{Shape, TensorData, backend::Backend};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn bool_slice(tensor: NdArrayTensor, slices: &[deepcode_tensor::Slice]) -> NdArrayTensor {
