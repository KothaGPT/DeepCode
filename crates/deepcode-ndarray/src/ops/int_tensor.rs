...
use alloc::vec::Vec;
use deepcode_tensor::{Distribution, ops::IntTensor};
use deepcode_tensor::{IntDType, ops::IntTensorOps};
use deepcode_tensor::{TensorMetadata, ops::FloatTensor};

use deepcode_tensor::ElementConversion;
...
use deepcode_tensor::{DType, Shape, TensorData, backend::Backend};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn int_slice(tensor: NdArrayTensor, slices: &[deepcode_tensor::Slice]) -> NdArrayTensor {
