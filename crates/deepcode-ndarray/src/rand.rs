//! Random number generation utilities for deepcode-ndarray
...
/// Type alias for the RNG used by deepcode-ndarray
#[cfg(feature = "std")]
...
pub fn get_seeded_rng() -> NdArrayRng {
    // Use the standard implementation from deepcode-common
    deepcode_common::rand::get_seeded_rng()
}
