...
//! can run on multiple GPU backends using DeepCL.
//!
...
/// For more details, see the DeepCL documentation.
///
/// ```ignore
/// use deepcl_reduce::instructions::Sum;
///
/// let client = /* ... */;
