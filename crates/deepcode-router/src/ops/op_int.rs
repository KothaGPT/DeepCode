...
use deepcode_tensor::ops::{BoolTensor, FloatElem, FloatTensor, IntElem, IntTensor, IntTensorOps};
use deepcode_tensor::{
...
impl<R: RunnerChannel> IntTensorOps<Self> for BackendRouter<R> {
    ...
    fn int_cast(tensor: IntTensor<Self>, dtype: deepcode_tensor::IntDType) -> IntTensor<Self> {
        let client = tensor.client.clone();
