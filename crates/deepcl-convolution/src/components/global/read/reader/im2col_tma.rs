use deepcl_core::{self as deepcl, prelude::barrier::Barrier};
use deepcl_core::{intrinsic, prelude::*};

use deepcl_matmul::components::{MatrixPrecision, StageIdent, stage::StageMemoryConfig};
...
use deepcl_matmul::components::stage::{ColMajorTilingOrder, ContiguousTilingLayout, StridedStage};
