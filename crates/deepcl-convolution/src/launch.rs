...
use deepcl_core::{Runtime, client::ComputeClient, prelude::*};
use deepcl_matmul::{MatmulInputHandleRef, components::AccG};
...
/// Perform an n-dimensional convolution using the implicit GEMM (im2col) algorithm, using deepcl
