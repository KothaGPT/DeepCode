...
macro_rules! testgen_conv2d_accelerated {
    ([$($float:ident: $acc: ident),*]) => {
        ...
        mod conv2d_accelerated {
            use super::*;
            use deepcl_std::CubeOption;
            use deepcl_matmul::components::tile::io::Strided;
            type TMM = deepcl_matmul::components::tile::accelerated::AcceleratedMatmul<CubeOption<Strided>>;
