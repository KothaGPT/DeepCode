...
macro_rules! conv2d_standard_tests {
    () => {
        use deepcl_matmul::components::{PartitionSize, StageSize, TileSize};
    ...
    ($tile:expr, $partition:expr, $stage:expr, $problem:expr) => {
        use deepcl_matmul::components::global::args::{TensorArgs, TensorMapArgs};
        ...
        pub fn simple_coalesced_im2col() {
            deepcl_convolution::tests::test_algo::<
