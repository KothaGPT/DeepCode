...
// deepcode-import. The `node_registry!` macro auto-generates all conversion logic.
//
// # How to Add a New Operation
//
// 1. Implement the node in `src/deepcode/node/<operation>.rs`:
...
//
// 2. Add module declaration in `src/deepcode/mod.rs`:
//    ```rust
//    pub(crate) mod node {
//        // ...
