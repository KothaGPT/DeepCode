...
impl ReshapeNode {
    ...
    fn reshape_shape_input(&self, input_shape: &crate::deepcode::ShapeType) -> TokenStream {
...
mod tests {
    ...
    fn test_codegen_reshape_to_scalar() {
        use crate::deepcode::ScalarType;

        let mut graph = DeepcodeGraph::<FullPrecisionSettings>::default();

        graph.register(ReshapeNode::new(
            Type::Tensor(TensorType::new_float("tensor1", 2)),
            Type::Scalar(ScalarType::new("output", crate::deepcode::ScalarKind::Float32)),
