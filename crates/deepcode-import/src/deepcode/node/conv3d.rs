...
impl<PS: PrecisionSettings> NodeCodegen<PS> for Conv3dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::PaddingConfig3d");
        imports.register("deepcode::nn::conv::Conv3d");
        imports.register("deepcode::nn::conv::Conv3dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::PaddingConfig3d;
            use deepcode::nn::conv::Conv3d;
            use deepcode::nn::conv::Conv3dConfig;
