...
impl<PS: PrecisionSettings> NodeCodegen<PS> for ConvTranspose3dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::conv::ConvTranspose3d");
        imports.register("deepcode::nn::conv::ConvTranspose3dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::conv::ConvTranspose3d;
            use deepcode::nn::conv::ConvTranspose3dConfig;
