...
use crate::deepcode::{DeepcodeImports, Scope, ToTokens, Type};
        ...
        match (&self.input, &self.output) {
            (Type::Tensor(input), Type::Tensor(output)) => {
                ...
                let output_type = match &output.kind {
                    crate::deepcode::TensorKind::Int => quote! { Tensor<B, #output_rank, Int> },
                    crate::deepcode::TensorKind::Float => quote! { Tensor<B, #output_rank> },
                    crate::deepcode::TensorKind::Bool => quote! { Tensor<B, #output_rank, Bool> },
                };
            ...
            (Type::Scalar(scalar), Type::Shape(shape)) => {
                ...
                let value_expr = match &scalar.kind {
                    crate::deepcode::ScalarKind::Int64 => quote! { #input_name },
                    crate::deepcode::ScalarKind::Int32 => quote! { #input_name as i64 },
                    _ => panic!(
