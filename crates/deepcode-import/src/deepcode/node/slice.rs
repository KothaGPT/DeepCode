...
impl SliceNode {
    ...
    fn generate_tensor_slice(
        &self,
        tensor: &crate::deepcode::TensorType,
        scope: &mut Scope,
        node_position: usize,
    ...
    fn generate_shape_slice(
        &self,
        shape: &crate::deepcode::ShapeType,
        output: &proc_macro2::Ident,
    ) -> TokenStream {
...
mod tests {
    use super::*;
    use crate::deepcode::{ShapeType, TensorType, graph::DeepcodeGraph, node::test::assert_tokens};
    ...
    fn test_codegen_slice_tensor_runtime_scalars() {
        ...
        graph.register(SliceNode::new(
            ...
            SliceParam::Runtime(Type::Scalar(crate::deepcode::ScalarType::new(
                "start",
                crate::deepcode::ScalarKind::Int64,
            ))),
            SliceParam::Runtime(Type::Scalar(crate::deepcode::ScalarType::new(
                "end",
                crate::deepcode::ScalarKind::Int64,
