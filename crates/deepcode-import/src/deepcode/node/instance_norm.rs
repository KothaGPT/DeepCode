...
impl<PS: PrecisionSettings> NodeCodegen<PS> for InstanceNormNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::InstanceNorm");
        imports.register("deepcode::nn::InstanceNormConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::InstanceNorm;
            use deepcode::nn::InstanceNormConfig;
