...
impl<PS: PrecisionSettings> NodeCodegen<PS> for MaxPool2dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        ...
        imports.register("deepcode::nn::pool::MaxPool2d");
        imports.register("deepcode::nn::pool::MaxPool2dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::pool::MaxPool2d;
            use deepcode::nn::pool::MaxPool2dConfig;
