...
use crate::deepcode::{DeepcodeImports, Scope, TensorKind, TensorType, Type};
...
impl<PS: PrecisionSettings> NodeCodegen<PS> for AttentionNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::tensor::activation::softmax");
    }
...
mod tests {
    ...
    pub(crate) fn one_node_graph<T: NodeCodegen<FullPrecisionSettings> + Clone + 'static>(
        ...
        let mut imports = DeepcodeImports::default();
