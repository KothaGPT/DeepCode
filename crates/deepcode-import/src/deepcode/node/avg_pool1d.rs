...
impl<PS: PrecisionSettings> NodeCodegen<PS> for AvgPool1dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::PaddingConfig1d");
        imports.register("deepcode::nn::pool::AvgPool1d");
        imports.register("deepcode::nn::pool::AvgPool1dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::PaddingConfig1d;
            use deepcode::nn::pool::AvgPool1d;
            use deepcode::nn::pool::AvgPool1dConfig;
