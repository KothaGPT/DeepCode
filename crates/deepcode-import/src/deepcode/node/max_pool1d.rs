...
impl<PS: PrecisionSettings> NodeCodegen<PS> for MaxPool1dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        ...
        imports.register("deepcode::nn::pool::MaxPool1d");
        imports.register("deepcode::nn::pool::MaxPool1dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::pool::MaxPool1d;
            use deepcode::nn::pool::MaxPool1dConfig;
