...
use crate::deepcode::{DeepcodeImports, OtherType, Scope, TensorType, Type};
...
impl<PS: PrecisionSettings> NodeCodegen<PS> for GlobalAvgPoolNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        match self.input.rank {
            3 => {
                imports.register("deepcode::nn::pool::AdaptiveAvgPool1d");
                imports.register("deepcode::nn::pool::AdaptiveAvgPool1dConfig");
            }
            4 => {
                imports.register("deepcode::nn::pool::AdaptiveAvgPool2d");
                imports.register("deepcode::nn::pool::AdaptiveAvgPool2dConfig");
            }
            dim => panic!("Unsupported input dim ({dim}) for GlobalAvgPoolNode"),
        }
    }
...
mod tests {
    ...
    fn test_codegen_2d() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::pool::AdaptiveAvgPool2d;
            use deepcode::nn::pool::AdaptiveAvgPool2dConfig;
    ...
    fn test_codegen_1d() {
        ...
        let expected = quote! {
            use deepcode::prelude::*;
            use deepcode::nn::pool::AdaptiveAvgPool1d;
            use deepcode::nn::pool::AdaptiveAvgPool1dConfig;
