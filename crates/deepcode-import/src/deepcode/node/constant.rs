    ...
    pub fn ty_tokens(&self) -> TokenStream {
        match self {
            ...
            ConstantValue::Tensor(tensor_type, _) => {
                ...
                quote! { deepcode::module::Param<#ty>}
            }
        ...
        match &self.value {
            ConstantValue::Tensor(tensor_type, data) => {
                ...
                match tensor_type.kind {
                    crate::deepcode::TensorKind::Int => Some(quote! {
                        let #name: deepcode::module::Param<#ty> = deepcode::module::Param::uninitialized(
                            deepcode::module::ParamId::new(),
                            move |device, _require_grad| Tensor::<B, #rank, Int>::zeros(#shape, device),
                            device.clone(),
                            false
                        );
                    }),
                    crate::deepcode::TensorKind::Float => Some(quote! {
                        let #name: deepcode::module::Param<#ty> = deepcode::module::Param::uninitialized(
                            deepcode::module::ParamId::new(),
                    ...
                    crate::deepcode::TensorKind::Bool => Some(quote! {
                        let #name: deepcode::module::Param<#ty> = deepcode::module::Param::uninitialized(
                            deepcode::module::ParamId::new(),
...
mod tests {
    use super::*;
    use crate::deepcode::{
        ScalarKind, ScalarType, ShapeType, TensorType, graph::DeepcodeGraph, node::test::assert_tokens,
    };
    use deepcode::record::FullPrecisionSettings;
    use deepcode::tensor::TensorData;
    use quote::ToTokens;
    ...
    fn test_codegen_constant_tensor_float() {
        ...
        let expected = quote! {
            ...
            #[derive(Module, Debug)]
            pub struct Model<B: Backend> {
                const_tensor:  deepcode::module::Param<Tensor<B, 1>>,
                phantom: core::marker::PhantomData<B>,
                device: deepcode::module::Ignored<B::Device>,
            }
            ...
            impl<B: Backend> Model<B> {
                #[allow(unused_variables)]
                pub fn new(device: &B::Device) -> Self {
                    let const_tensor: deepcode::module::Param<Tensor<B, 1>> = deepcode::module::Param::uninitialized(
                        deepcode::module::ParamId::new(),
    ...
    fn test_codegen_constant_tensor_int() {
        ...
        let expected = quote! {
            ...
            #[derive(Module, Debug)]
            pub struct Model<B: Backend> {
                const_tensor_int: deepcode::module::Param<Tensor<B, 1, Int>>,
                phantom: core::marker::PhantomData<B>,
                device: deepcode::module::Ignored<B::Device>,
            }
            ...
            impl<B: Backend> Model<B> {
                #[allow(unused_variables)]
                pub fn new(device: &B::Device) -> Self {
                    let const_tensor_int: deepcode::module::Param<Tensor<B, 1, Int>> = deepcode::module::Param::uninitialized(
                        deepcode::module::ParamId::new(),
    ...
    fn test_codegen_constant_tensor_bool() {
        ...
        let expected = quote! {
            ...
            #[derive(Module, Debug)]
            pub struct Model<B: Backend> {
                const_tensor_3d: deepcode::module::Param<Tensor<B, 3, Bool>>,
                phantom: core::marker::PhantomData<B>,
                device: deepcode::module::Ignored<B::Device>,
            }
            ...
            impl<B: Backend> Model<B> {
                #[allow(unused_variables)]
                pub fn new(device: &B::Device) -> Self {
                    let const_tensor_3d: deepcode::module::Param<Tensor<B, 3, Bool>> = deepcode::module::Param::uninitialized(
                        deepcode::module::ParamId::new(),
