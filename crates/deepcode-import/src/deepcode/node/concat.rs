    ...
    fn forward(&self, scope: &mut Scope, node_position: usize) -> TokenStream {
        match &self.output {
            Type::Tensor(output_tensor) => {
                ...
                quote! {
                    let #output = deepcode::tensor::Tensor::cat([#(#inputs),*].into(), #dim);
                }
            }
...
mod tests {
        ...
        let expected = quote! {
            ...
            impl<B: Backend> Model <B> {
                ...
                pub fn forward(
                    ...
                    let tensor3 = deepcode::tensor::Tensor::cat([tensor1, tensor2].into(), 1);
    ...
    fn test_codegen_concat_shapes() {
        ...
        graph.register(ConcatNode::new(
            vec![
                Type::Shape(crate::deepcode::ShapeType::new("shape1", 2)),
                Type::Shape(crate::deepcode::ShapeType::new("shape2", 3)),
                Type::Shape(crate::deepcode::ShapeType::new("shape3", 1)),
            ],
            Type::Shape(crate::deepcode::ShapeType::new("output_shape", 6)),
            0,
        ));
