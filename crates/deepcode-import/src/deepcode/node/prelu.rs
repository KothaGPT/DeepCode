...
impl<PS: PrecisionSettings> NodeCodegen<PS> for PReluNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::PRelu");
        imports.register("deepcode::nn::PReluConfig");
    }
    ...
    fn from_onnx(node: onnx_ir::Node) -> Self {
        ...
        let weight_shape = if weight.shape.len() > 1 {
            ...
            if trailing_dims_product == 1 {
                // Flatten to rank 1 as Deepcode expects
...
mod tests {
    ...
    fn test_codegen() {
        ...
        use deepcode::nn::PRelu;
        use deepcode::nn::PReluConfig;
        #[derive(Module, Debug)]
