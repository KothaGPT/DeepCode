...
impl<PS: PrecisionSettings> NodeCodegen<PS> for ConvTranspose2dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::conv::ConvTranspose2d");
        imports.register("deepcode::nn::conv::ConvTranspose2dConfig");
    }
...
mod tests {
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::conv::ConvTranspose2d;
            use deepcode::nn::conv::ConvTranspose2dConfig;
