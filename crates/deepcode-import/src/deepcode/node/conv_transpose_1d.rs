...
impl<PS: PrecisionSettings> NodeCodegen<PS> for ConvTranspose1dNode {
    ...
    fn register_imports(&self, imports: &mut DeepcodeImports) {
        imports.register("deepcode::nn::conv::ConvTranspose1d");
        imports.register("deepcode::nn::conv::ConvTranspose1dConfig");
    }
...
impl OnnxIntoNode for ConvTranspose1dNode {
    fn from_onnx(node: onnx_ir::Node) -> Self {
        ...
        let config = deepcode::nn::conv::ConvTranspose1dConfig::new(
...
mod tests {
    ...
    use deepcode::{nn::conv::ConvTranspose1dConfig, record::FullPrecisionSettings};
    ...
    fn test_codegen() {
        ...
        let expected = quote! {
            ...
            use deepcode::nn::conv::ConvTranspose1d;
            use deepcode::nn::conv::ConvTranspose1dConfig;
