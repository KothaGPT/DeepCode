/// Master node registry - auto-generates ONNX to Deepcode conversion infrastructure.
///
...
///
/// See: `contributor-book/src/guides/onnx-to-deepcode-conversion-tool.md`
macro_rules! node_registry {
    (
        ...
        #[derive(Debug, Clone)]
        pub enum Node<PS: deepcode::record::PrecisionSettings> {
            $(
        ...
        impl<PS: deepcode::record::PrecisionSettings> Node<PS> {
        ...
        pub(crate) fn try_convert_onnx_node<PS: deepcode::record::PrecisionSettings>(
            node: onnx_ir::Node,
        ) -> Option<Node<PS>> {
