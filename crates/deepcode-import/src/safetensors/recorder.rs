...
/// Recorder for loading HuggingFace Safetensors files (`.safetensors`) into Deepcode modules.
///
...
///
/// ```rust,ignore
/// use deepcode_import::safetensors::{AdapterType, LoadArgs, SafetensorsFileRecorder};
...
/// between the source framework and Deepcode.
