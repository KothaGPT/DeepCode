...
use deepcode::record::serde::{
    adapter::{DeepcodeModuleAdapter, DefaultAdapter},
    data::NestedValue,
    ser::Serializer,
};
...
/// A PyTorch adapter for the Deepcode module used during deserialization.
///
/// Not all Deepcode module correspond to a PyTorch module. Therefore,
/// we need to adapt the Deepcode module to a PyTorch module. We implement
...
impl<PS: PrecisionSettings, B: Backend> DeepcodeModuleAdapter for PyTorchAdapter<PS, B> {
...
/// than Deepcode. Deepcode uses gamma and beta, while PyTorch uses weight and bias.
