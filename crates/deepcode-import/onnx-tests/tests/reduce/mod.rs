...
mod tests {
    use super::*;
    use deepcode::tensor::{Tensor, TensorData, ops::FloatElem};
    ...
    fn reduce_sum() {
        ...
        output4
            .to_data()
            .assert_approx_eq::<FT>(&expected4, deepcode::tensor::Tolerance::default());
        output5.to_data().assert_eq(&expected5, true);
        output6
            .to_data()
            .assert_approx_eq::<FT>(&expected6, deepcode::tensor::Tolerance::default());
    }
    ...
    fn reduce_prod() {
        ...
        output3
            .to_data()
            .assert_approx_eq::<FT>(&expected3, deepcode::tensor::Tolerance::default());
        output4
            .to_data()
            .assert_approx_eq::<FT>(&expected4, deepcode::tensor::Tolerance::default());
    }
    ...
    fn reduce_mean() {
        ...
        output5
            .to_data()
            .assert_approx_eq::<FT>(&expected5, deepcode::tensor::Tolerance::default());
        output6
            .to_data()
            .assert_approx_eq::<FT>(&expected6, deepcode::tensor::Tolerance::default());
    }
    ...
    fn reduce_sum_square() {
        ...
        output2
            .to_data()
            .assert_approx_eq::<FT>(&expected2, deepcode::tensor::Tolerance::default());
        output3
            .to_data()
            .assert_approx_eq::<FT>(&expected3, deepcode::tensor::Tolerance::default());
        output4
    ...
    fn reduce_mean_partial_shape() {
        ...
        output
            .to_data()
            .assert_approx_eq::<FT>(&expected, deepcode::tensor::Tolerance::default());
    }
}
