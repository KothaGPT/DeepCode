...
mod tests {
    use super::*;
    use deepcode::tensor::{Int, Tensor, TensorData};
    ...
    fn gather_constant_2d_indices() {
        ...
        // The actual values depend on how deepcode-import handles constant lifting

        // Just verify we get the expected output shape
        // The shape should be [1, 5, 7] regardless of the input method
    }

    // TODO: Add test for negative indices on tensors once Deepcode tensor operations support them
