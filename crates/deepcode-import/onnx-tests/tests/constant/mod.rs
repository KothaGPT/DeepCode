...
mod tests {
    use super::*;
    use deepcode::tensor::{Int, Shape, Tensor};
    ...
    fn constant_tensor_bool_test() {
        ...
        let expected = deepcode::tensor::TensorData::from(expected_data);
