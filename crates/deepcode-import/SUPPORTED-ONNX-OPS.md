...
This table lists the support status for ONNX operators in Deepcode. Note that some
...
represent Deepcode's implementation of dimension-specific versions of the
corresponding ONNX operators to make the mapping clearer between ONNX and Deepcode
functionality.

| ONNX OP                          | Import Support | Deepcode Support |
|----------------------------------|:--------------:|:------------:|
| [Abs][1]                         | ✅             | ✅           |
| [Acos][2]                        | ❌             | ❌           |
| [Acosh][3]                       | ❌             | ❌           |
