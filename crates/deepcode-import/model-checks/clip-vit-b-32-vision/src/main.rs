...
#[cfg(feature = "wgpu")]
pub type MyBackend = deepcode::backend::Wgpu;

#[cfg(feature = "ndarray")]
pub type MyBackend = deepcode::backend::NdArray<f32>;

#[cfg(feature = "tch")]
pub type MyBackend = deepcode::backend::LibTorch<f32>;

#[cfg(feature = "metal")]
pub type MyBackend = deepcode::backend::Metal;
...
fn main() {
    println!("========================================");
    println!("CLIP ViT-B-32-vision Deepcode Model Test");
    println!("========================================\n");
