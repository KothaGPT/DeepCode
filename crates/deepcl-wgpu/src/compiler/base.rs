...
#[cfg(feature = "msl")]
use deepcl_cpp::shared::MslComputeKernel;
...
pub enum AutoCompiler {
    Wgsl(WgslCompiler),
    #[cfg(feature = "spirv")]
    SpirV(deepcl_spirv::SpirvCompiler),
    #[cfg(feature = "msl")]
    Msl(deepcl_cpp::MslCompiler),
}
...
pub enum AutoRepresentation {
    ...
    #[cfg(feature = "spirv")]
    SpirV(deepcl_spirv::SpirvKernel),
    #[cfg(feature = "msl")]
...
impl AutoRepresentation {
    pub fn as_spirv(&self) -> Option<&deepcl_spirv::SpirvKernel> {
        match self {
    ...
    fn compile(
        ...
        match self {
            ...
            AutoCompiler::Msl(msl_compiler) => {
                ...
                use deepcl_cpp;
                let compilation_options = deepcl_cpp::shared::CompilationOptions::default();
                Compiler::compile(msl_compiler, kernel, &compilation_options, mode).into()
            }
        }
    }

    fn elem_size(&self, elem: deepcl_core::ir::ElemType) -> usize {
        match self {
