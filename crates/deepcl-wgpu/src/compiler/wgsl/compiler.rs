...
use deepcl_core::post_processing::{
...
impl deepcl_core::Compiler for WgslCompiler {
    ...
    pub(crate) fn compile_variable(&mut self, value: cube::Variable) -> wgsl::Variable {
        ...
        match value.kind {
            ...
            cube::VariableKind::Builtin(builtin) => match builtin {
                ...
                cube::Builtin::DeepClusterDim
                | cube::Builtin::DeepClusterDimX
                | cube::Builtin::DeepClusterDimY
                | cube::Builtin::DeepClusterDimZ => self.constant_var(1),
