...
use deepcl_core::{ExecutionMode, WgpuCompilationOptions, prelude::CompiledKernel};
use deepcl_runtime::DeviceProperties;
use wgpu::{
...
use super::metal;
#[cfg(all(feature = "msl", target_os = "macos"))]
use deepcl_cpp::metal as cpp_metal;
    ...
    pub fn create_pipeline(
        ...
        let layout = bindings_info.map(|bindings| {
            ...
            if !cfg!(exclusive_memory_only) {
                bindings.fill(deepcl_core::compute::Visibility::ReadWrite);
            }
                ...
                .map(|(i, visibility)| BindGroupLayoutEntry {
                    ...
                    ty: BindingType::Buffer {
                        ty: BufferBindingType::Storage {
                            read_only: matches!(visibility, deepcl_core::compute::Visibility::Read),
                        },
