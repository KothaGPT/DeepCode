use deepcode::optim::{SgdConfig, momentum::MomentumConfig};
...
use {deepcode::backend::Autodiff, custom_image_dataset::training::train};
...
fn main() {
    ...
    #[cfg(feature = "metal")]
    {
        ...
        use deepcode::backend::wgpu::{Metal, WgpuDevice};
