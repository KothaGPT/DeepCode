...
type ElemType = f32;
#[cfg(feature = "f16")]
type ElemType = deepcode::tensor::f16;
#[cfg(feature = "flex32")]
type ElemType = deepcode::tensor::flex32;
...
mod tch_gpu {
    use crate::{ElemType, launch};
    use deepcode::backend::autodiff::checkpoint::strategy::BalancedCheckpointing;
    use deepcode::backend::{
        Autodiff,
...
mod wgpu {
    use crate::{ElemType, launch};
    use deepcode::backend::{Autodiff, wgpu::Wgpu};
...
mod vulkan {
    use crate::{ElemType, launch};
    use deepcode::backend::{Autodiff, Vulkan, autodiff::checkpoint::strategy::BalancedCheckpointing};
...
mod metal {
    use crate::{ElemType, launch};
    use deepcode::backend::{Autodiff, Metal};
...
mod cuda {
    ...
    use deepcode::backend::{Autodiff, Cuda, autodiff::checkpoint::strategy::BalancedCheckpointing};
...
mod rocm {
    use crate::{ElemType, launch};
    use deepcode::backend::{Autodiff, Rocm, autodiff::checkpoint::strategy::BalancedCheckpointing};
