# Adding a New Operation to deepcode
...
## Adding the Op to deepcode-autodiff
...
Here is where code was added for powf in `deepcode-deepcl` and `deepcl`:
...
## Adding the Op to deepcode-import
